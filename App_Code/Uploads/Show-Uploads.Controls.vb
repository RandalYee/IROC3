...
' Show_Uploads.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Show_Uploads
...
' Base class for the UploadsRecordControl control on the Show_Uploads page.
...
Public Class BaseUploadsRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.UploadsDialogEditButton.Click, AddressOf UploadsDialogEditButton_Click
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in Show-Uploads") = recId
        ...
        Public Overridable Sub UploadsDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
       ...
       ' Upon error, rollback the transaction
        ...
        Public Overridable Sub Request_Id_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../Request_Master/Show-Request-Master.aspx?Request_Master={UploadsRecordControl:FK:Uploads_FK00}"
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property UploadsDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UploadsDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
