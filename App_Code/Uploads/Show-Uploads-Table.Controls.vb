...
' Show_Uploads_Table.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Show_Uploads_Table
...
' Base class for the UploadsTableControlRow control on the Show_Uploads_Table page.
...
' Base class for the UploadsTableControl control on the Show_Uploads_Table page.
...
Public Class BaseUploadsTableControl
        ...
        Protected Overridable Sub Control_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
           ...
           ' Setup the filter and search.
            ...
            If Not Me.Page.IsPostBack Then
                ...
                If  Me.InSession(Me.UPLOAD_DescFilter) 				
                    initialVal = Me.GetFromSession(Me.UPLOAD_DescFilter)
                
                Else
                    
                    initialVal = EvaluateFormula("URL(""UPLOAD_Desc"")")
                
              End If
              
                If initialVal <> ""				
                        
                        Dim UPLOAD_DescFilteritemListFromSession() As String = initialVal.Split(","c)
                        Dim index As Integer = 0
                        For Each item As String In UPLOAD_DescFilteritemListFromSession
                            If index = 0 AndAlso _
                               item.ToString.Equals("") Then
                            Else
                                Me.UPLOAD_DescFilter.Items.Add(item)
                                Me.UPLOAD_DescFilter.Items.Item(index).Selected = True
                                index += 1
                            End If
                        Next
                        Dim listItem As ListItem
                        For Each listItem In Me.UPLOAD_DescFilter.Items
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            AddHandler Me.UploadsSearchButton.Button.Click, AddressOf UploadsSearchButton_Click
              ...
              url = Me.ModifyRedirectUrl("../Uploads/Uploads-QuickSelector.aspx", "", True)
              url = Me.Page.ModifyRedirectUrl(url, "", True)                  
              Me.UPLOAD_DescFilter.PostBackUrl = url & "?Target=" & Me.UPLOAD_DescFilter.ClientID & "&IndexField=" & CType(Me.Page, BaseApplicationPage).Encrypt("UPLOAD_Desc")& "&EmptyValue=" & CType(Me.Page, BaseApplicationPage).Encrypt("--ANY--") & "&EmptyDisplayText=" & CType(Me.Page, BaseApplicationPage).Encrypt(Me.Page.GetResourceValue("Txt:All"))
              Me.UPLOAD_DescFilter.Attributes.Item("onClick") = "initializePopupPage(this, '" & Me.UPLOAD_DescFilter.PostBackUrl & "', true, event); return false;"                  
                
              AddHandler Me.UPLOAD_DescFilter.SelectedIndexChanged, AddressOf UPLOAD_DescFilter_SelectedIndexChanged                  
        ...
        Public Overrides Sub DataBind()
          ...
          Next
            ...
            ' Call the Set methods for each controls on the panel
                ...
                SetUPLOAD_DescFilter()
                SetUPLOAD_DescLabel()
                SetUPLOAD_DescLabel1()
                SetUPLOAD_DtLabel()
                SetUPLOAD_FileLabel()
    ...
    End Sub
        ...
        Public Overridable Sub ResetControl()
            ...
            Me.UPLOAD_DescFilter.ClearSelection()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            If IsValueSelected(Me.UPLOAD_DescFilter) Then
    
                Dim item As ListItem
                Dim selectedItemCount As Integer = 0
                For Each item In Me.UPLOAD_DescFilter.Items
                ...
                For Each item In Me.UPLOAD_DescFilter.Items
                    ...
                    End If
                    If item.Selected Then
                        filter.iOR(UploadsTable.UPLOAD_Desc, BaseFilter.ComparisonOperator.EqualsTo, item.Value, False, False)
                    End If
                Next
                wc.iAND(filter)
    ...
    End Function
      ...
      Dim appRelativeVirtualPath As String = CType(HttpContext.Current.Session("AppRelativeVirtualPath"), String)
            ...
            Dim UPLOAD_DescFilterSelectedValue As String = CType(HttpContext.Current.Session()(HttpContext.Current.Session.SessionID & appRelativeVirtualPath & "UPLOAD_DescFilter_Ajax"), String)
            If IsValueSelected(UPLOAD_DescFilterSelectedValue) Then
    
            If Not isNothing(UPLOAD_DescFilterSelectedValue) Then
                Dim UPLOAD_DescFilteritemListFromSession() As String = UPLOAD_DescFilterSelectedValue.Split(","c)
                Dim index As Integer = 0
                ...
                For Each item As String In UPLOAD_DescFilteritemListFromSession
                    ...
                    Else
                        filter.iOR(UploadsTable.UPLOAD_Desc, BaseFilter.ComparisonOperator.EqualsTo, item, False, False)
                        index += 1
                    End If
                Next
                wc.iAND(filter)
    ...
    Dim recControl As UploadsTableControlRow = DirectCast(repItem.FindControl("UploadsTableControlRow"), UploadsTableControlRow)
        ...
        Public Overridable Sub SetUPLOAD_DescLabel1()
        ...
        Public Overridable Sub SetUPLOAD_DescFilter()

            
            Dim UPLOAD_DescFilterselectedFilterItemList As New ArrayList()
            Dim UPLOAD_DescFilteritemsString As String = Nothing
            If (Me.InSession(Me.UPLOAD_DescFilter)) Then
                UPLOAD_DescFilteritemsString = Me.GetFromSession(Me.UPLOAD_DescFilter)
            End If
            
            If (UPLOAD_DescFilteritemsString IsNot Nothing) Then
                Dim UPLOAD_DescFilteritemListFromSession() As String = UPLOAD_DescFilteritemsString.Split(","c)
                For Each item as String In UPLOAD_DescFilteritemListFromSession
                    UPLOAD_DescFilterselectedFilterItemList.Add(item)
                Next
            End If
              
            		
            Me.PopulateUPLOAD_DescFilter(GetSelectedValueList(Me.UPLOAD_DescFilter, UPLOAD_DescFilterselectedFilterItemList), 500)
        ...
        ' Get the filters' data for UPLOAD_DescFilter
        Protected Overridable Sub PopulateUPLOAD_DescFilter(ByVal selectedValue As ArrayList, ByVal maxItems As Integer)
                    
            'Setup the WHERE clause.
            
            Dim wc As WhereClause = Me.CreateWhereClause_UPLOAD_DescFilter()
            Me.UPLOAD_DescFilter.Items.Clear()
            		  			
            ' Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_UPLOAD_DescFilter function.
            ' It is better to customize the where clause there.
                
            
            
            Dim orderBy As OrderBy = New OrderBy(False, False)
            orderBy.Add(UploadsTable.UPLOAD_Desc, OrderByItem.OrderDir.Asc)                
            ...
            If wc.RunQuery Then
                ...
                values = UploadsTable.GetValues(UploadsTable.UPLOAD_Desc, wc, orderBy, maxItems)
            ...
            For Each cvalue In values
                ...
                If ( UploadsTable.UPLOAD_Desc.IsColumnValueTypeBoolean()) Then
                    fvalue = cvalue
                Else
                    fvalue = UploadsTable.UPLOAD_Desc.Format(cvalue)
                End If
                ...
                Dim dupItem As ListItem = Me.UPLOAD_DescFilter.Items.FindByText(fvalue)
                ...
                Me.UPLOAD_DescFilter.Items.Add(newItem)
            ...
            Me.UPLOAD_DescFilter.SetFieldMaxLength(50)
                                 
                  
            ' Add the selected value.
            If Me.UPLOAD_DescFilter.Items.Count = 0 Then
                Me.UPLOAD_DescFilter.Items.Add(New ListItem(Page.GetResourceValue("Txt:All", "IROC2"), "--ANY--"))
            End If
            
            ' Mark all items to be selected.
            For Each item As ListItem in Me.UPLOAD_DescFilter.Items
                item.Selected = True
            Next
        ...
        Public Overridable Function CreateWhereClause_UPLOAD_DescFilter() As WhereClause
          
            ' Create a where clause for the filter UPLOAD_DescFilter.
            ' This function is called by the Populate method to load the items 
            ' in the UPLOAD_DescFilterQuickSelector
            ...
            UPLOAD_DescFilterselectedFilterItemList = GetSelectedValueList(Me.UPLOAD_DescFilter, UPLOAD_DescFilterselectedFilterItemList) 
            Dim wc As New WhereClause
            If UPLOAD_DescFilterselectedFilterItemList Is Nothing OrElse UPLOAD_DescFilterselectedFilterItemList.Count = 0 Then
                wc.RunQuery = False
            Else            
                For Each item As String In UPLOAD_DescFilterselectedFilterItemList
              
            
      
   
                    wc.iOR(UploadsTable.UPLOAD_Desc, BaseFilter.ComparisonOperator.EqualsTo, item)
        ...
        Protected Overrides Sub SaveControlsToSession()
            ...
            Dim UPLOAD_DescFilterselectedFilterItemList As ArrayList = GetSelectedValueList(Me.UPLOAD_DescFilter, Nothing)
            Dim UPLOAD_DescFilterSessionString As String = ""
            If Not UPLOAD_DescFilterselectedFilterItemList is Nothing Then
            For Each item As String In UPLOAD_DescFilterselectedFilterItemList
                UPLOAD_DescFilterSessionstring = UPLOAD_DescFilterSessionstring & "," & item
            Next
            End If
            Me.SaveToSession(Me.UPLOAD_DescFilter, UPLOAD_DescFilterSessionstring)
        ...
        Protected  Sub SaveControlsToSession_Ajax()
            ...
            Next
            End If
            Me.SaveToSession("UPLOAD_DescFilter_Ajax", UPLOAD_DescFilterSessionString)
      ...
      Me.SaveToSession("UploadsSearch_Ajax", Me.UploadsSearch.Text)
        ...
        Protected Overrides Sub ClearControlsFromSession()
            ...
            Me.RemoveFromSession(Me.UPLOAD_DescFilter)
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Uploads-Table.UploadsPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Uploads"
                ' If Show-Uploads-Table.UploadsPDFButton.report specifies a valid report template,
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Uploads-Table.UploadsWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Uploads"
                ' If Show-Uploads-Table.UploadsWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
    ...
    Try
        ...
        Protected Overridable Sub UPLOAD_DescFilter_SelectedIndexChanged(ByVal sender As Object, ByVal args As EventArgs)
           ' Setting the DataChanged to True results in the page being refreshed with
           ' the most recent data from the database.  This happens in PreRender event
           ' based on the current sort, search and filter criteria.
           Me.DataChanged = True
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property UPLOAD_DescFilter() As BaseClasses.Web.UI.WebControls.QuickSelector
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UPLOAD_DescFilter"), BaseClasses.Web.UI.WebControls.QuickSelector)
            End Get
        End Property
        ...
        Public ReadOnly Property UPLOAD_DescLabel1() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UPLOAD_DescLabel1"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
...
' Base class for the Request_MasterRecordControl control on the Show_Uploads_Table page.
...
Public Class BaseRequest_MasterRecordControl
        ...
        Dim parentCtrl As UploadsTableControlRow
          
          				  
          parentCtrl = DirectCast(MiscUtils.GetParentControlObject(Me, "UploadsTableControlRow"), UploadsTableControlRow)				  
      ...
      Dim selectedRecordKeyValue as KeyValue = New KeyValue()
        ...
        Dim uploadsRecordObj as KeyValue
        uploadsRecordObj = Nothing
      
              Dim uploadsTableControlObjRow As UploadsTableControlRow = DirectCast(MiscUtils.GetParentControlObject(Me, "UploadsTableControlRow") ,UploadsTableControlRow)
            
                If (Not IsNothing(uploadsTableControlObjRow) AndAlso Not IsNothing(uploadsTableControlObjRow.GetRecord()) AndAlso Not IsNothing(uploadsTableControlObjRow.GetRecord().Request_Id))
                    wc.iAND(Request_MasterTable.Request_Id, BaseFilter.ComparisonOperator.EqualsTo, uploadsTableControlObjRow.GetRecord().Request_Id.ToString())
                Else
                    wc.RunQuery = False
                    Return wc                    
                End If
      ...
      HttpContext.Current.Session("Request_MasterRecordControlWhereClause") = selectedRecordKeyValue.ToXmlString()
        ...
        Public Overridable Function CreateWhereClause(ByVal searchText As String, ByVal fromSearchControl As String, ByVal AutoTypeAheadSearch As String, ByVal AutoTypeAheadWordSeparators As String) As WhereClause
            ...
            Dim selectedRecordInUploadsTableControl as String = DirectCast(HttpContext.Current.Session("Request_MasterRecordControlWhereClause"), String)
            
            If Not selectedRecordInUploadsTableControl Is Nothing AndAlso KeyValue.IsXmlKey(selectedRecordInUploadsTableControl) Then
                Dim selectedRecordKeyValue as KeyValue = KeyValue.XmlToKey(selectedRecordInUploadsTableControl)
