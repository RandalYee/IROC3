...
' Edit_Uploads.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Edit_Uploads
...
Public Class UploadsRecordControl
  ...
  '           
  '              ' Validate UPLOAD_Quote Control
  '              validationMessage = EvaluateFormula("IF(ParseDecimal(UploadsRecordControl.UPLOAD_Quote.Text) < 100, ""Error: Must be over 100"", """")", Me.DataSource)
  '              If validationMessage <> "" AndAlso validationMessage.ToLower() <> "true"
...
' Base class for the UploadsRecordControl control on the Edit_Uploads page.
...
Public Class BaseUploadsRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "UploadsRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Me.DataSource = UploadsTable.GetRecord(recList(0).GetID.ToXmlString(), True)
        ...
        Public Overridable Sub SetUpload_Id()
            
        
            ' Set the Upload_Id Literal on the webpage with value from the
            ' DatabaseIROC%dbo.Uploads database record.

            ' Me.DataSource is the DatabaseIROC%dbo.Uploads record retrieved from the database.
            ' Me.Upload_Id is the ASP:Literal on the webpage.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.Upload_IdSpecified Then
                				
                ' If the Upload_Id is non-NULL, then format the value.

                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(UploadsTable.Upload_Id)
                              
                formattedValue = HttpUtility.HtmlEncode(formattedValue)
                Me.Upload_Id.Text = formattedValue
                
            Else 
            
                ' Upload_Id is NULL in the database, so use the Default Value.  
                ' Default Value could also be NULL.
        
                Me.Upload_Id.Text = UploadsTable.Upload_Id.Format(UploadsTable.Upload_Id.DefaultValue)
        ...
        Public Overridable Sub SetRequest_Id()
            ...
            Else 
                ...
                Me.Request_Id.Text = UploadsTable.Request_Id.DefaultValue		
                End If
        ...
        Public Overridable Sub SetUpload_IdLabel()
                  
                      'Code for the text property is generated inside the .aspx file.
                      'To override this property you can uncomment the following property and add your own value.
                      'Me.Upload_IdLabel.Text = "Some value"
        ...
        Public Overridable Sub GetUpload_Id()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            ' Retrieve the record id from the URL parameter.
                  ...
                  Dim recId As String = DirectCast(Me.Page, BaseApplicationPage).Decrypt(Me.Page.Request.QueryString.Item("Uploads"))
                
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "IROC2").Replace("{URL}", "Uploads"))
            End If
            HttpContext.Current.Session("QueryString in Edit-Uploads") = recId
        ...
        Protected Overridable Sub Control_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PreRender
			...
			Me.Page.Authorize(Ctype(Upload_Id, Control), "1")
					
			Me.Page.Authorize(Ctype(Upload_IdLabel, Control), "1")
        ...
        Protected Overridable Sub PopulateUPLOAD_DescDropDownList( _
            ...
            Me.UPLOAD_Desc.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Purchase Order"), "Purchase Order"))
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Upload_Id() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Upload_Id"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
            
        Public ReadOnly Property Upload_IdLabel() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Upload_IdLabel"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
