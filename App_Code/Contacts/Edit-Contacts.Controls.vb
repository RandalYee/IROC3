...
' Edit_Contacts.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Edit_Contacts
...
' Base class for the ContactsRecordControl control on the Edit_Contacts page.
...
Public Class BaseContactsRecordControl
        ...
        Public Overridable Sub SetType0()
            ...
            Else
                ...
                selectedValue = EvaluateFormula("""Requestor""")
            End If
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in Edit-Contacts") = recId
