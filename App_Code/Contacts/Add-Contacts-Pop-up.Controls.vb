...
' Add_Contacts_Pop_up.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Add_Contacts_Pop_up
...
' Base class for the ContactsRecordControl control on the Add_Contacts_Pop_up page.
...
Public Class BaseContactsRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.Type0.SelectedIndexChanged, AddressOf Type0_SelectedIndexChanged
        ...
        Public Overridable Sub SetType0()
            ...
            ' Set the Type DropDownList on the webpage with value from the
            ' DatabaseIROC%dbo.Contacts database record.
            
            ' Me.DataSource is the DatabaseIROC%dbo.Contacts record retrieved from the database.
            ' Me.Type0 is the ASP:DropDownList on the webpage.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.Type0Specified Then
                ...
                ' The Format method will use the Display Format
                selectedValue = Me.DataSource.Type0
            Else
                ...
                Else
                    selectedValue = ContactsTable.Type0.DefaultValue
                End If
            ...
            Me.PopulateType0DropDownList(selectedValue, 100)              
        ...
        Public Overridable Sub GetRequest_Id()
            ...
            'Save the value to data source
            Me.DataSource.Parse(Me.Request_Id.Text, ContactsTable.Request_Id)			
        ...
        Public Overridable Sub GetType0()
            ...
            ' Retrieve the value entered by the user on the Type ASP:DropDownList, and
            ' save it into the Type field in DataSource DatabaseIROC%dbo.Contacts record.
                        
            ' Custom validation should be performed in Validate, not here.
            
            Me.DataSource.Parse(GetValueSelectedPageRequest(Me.Type0), ContactsTable.Type0)				
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in Add-Contacts-Pop-up") = recId
        ...
        Public Overridable Function CreateWhereClause_Type0DropDownList() As WhereClause
        ...
        ' Fill the Type0 list.
        Protected Overridable Sub PopulateType0DropDownList( _
                ByVal selectedValue As String, _
                ByVal maxItems As Integer)
            		  					                
            Me.Type0.Items.Clear()
            
                    
            ' 1. Setup the static list items        
            							
            Me.Type0.Items.Add(New ListItem(Me.Page.ExpandResourceValue("{Txt:PleaseSelect}"), "--PLEASE_SELECT--"))
                            							
            Me.Type0.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Requester"), "Requester"))
                            							
            Me.Type0.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Assignee"), "Assignee"))
                            							
            Me.Type0.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Technical"), "Technical"))
                            							
            Me.Type0.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Contractor"), "Contractor"))
                            							
            Me.Type0.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Sub-Contractor"), "Sub-Contractor"))
                            							
            Me.Type0.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Electrical"), "Electrical"))
                            							
            Me.Type0.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Engineer"), "Engineer"))
                            							
            Me.Type0.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Reviewer"), "Reviewer"))
                            							
            Me.Type0.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Other"), "Other"))
                            							
            Me.Type0.Items.Add(New ListItem(Me.Page.ExpandResourceValue(""), ""))
            ...
            If Not selectedValue Is Nothing AndAlso _
                ...
                Not SetSelectedValue(Me.Type0, selectedValue) AndAlso _
                Not SetSelectedDisplayText(Me.Type0, selectedValue) AndAlso _
                Not SetSelectedDisplayText(Me.Type0, ContactsTable.Type0.Format(selectedValue))Then
                Dim fvalue As String = ContactsTable.Type0.Format(selectedValue)
                If fvalue Is Nothing OrElse fvalue.Trim() = "" Then fvalue = selectedValue
                ResetSelectedItem(Me.Type0, New ListItem(fvalue, selectedValue))
            End If					
        ...
        Protected Overridable Sub Type0_SelectedIndexChanged(ByVal sender As Object, ByVal args As EventArgs)

            ' for the value inserted by quick add button or large list selector, 
            ' the value is necessary to be inserted by this event during postback 
            Dim val As String = CType(Me.Page.Session()(Type0.ClientID & "_SelectedValue"), String)
            Dim displayText As String = CType(Me.Page.Session()(Type0.ClientID & "_SelectedDisplayText"), String)
            If displayText <> "" AndAlso val <> "" Then
                Me.Type0.Items.Add(New ListItem(displayText, val))
                Me.Type0.SelectedIndex = Me.Type0.Items.Count - 1
                Me.Page.Session.Remove(Type0.ClientID & "_SelectedValue")
                Me.Page.Session.Remove(Type0.ClientID & "_SelectedDisplayText")
            End If
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Type0() As System.Web.UI.WebControls.DropDownList
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Type0"), System.Web.UI.WebControls.DropDownList)
            End Get
        End Property
