...
' Comments_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Comments_QuickSelector
...
' Base class for the SelectorTableControlRow control on the Comments_QuickSelector page.
...
' Base class for the SelectorTableControl control on the Comments_QuickSelector page.
...
Public Class BaseSelectorTableControl
        ...
        Public Overridable Function GetColumnListFromURLParameters(ByVal includeIndexFieldParameter As Boolean, ByVal includeFormulaAndDFKAParameter As Boolean) As ColumnList
            ...
            If includeIndexFieldParameter AndAlso field <> "" Then
                Dim col As BaseColumn = CommentsTable.GetColumnByName(field)
                If col IsNot Nothing  AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
            End If
            If includeFormulaAndDFKAParameter Then
                If formula <> "" Then
                    For Each col As BaseColumn In MiscUtils.GetFormulaFieldList(formula, CommentsTable.Instance.TableDefinition)
                        If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                    Next
                
                ElseIf displayFieldName <> ""
                    Dim col As BaseColumn = CommentsTable.GetColumnByName(displayFieldName)
                    If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                End If
            End If
            Return columnList            
    ...
    End Function
      ...
      Next
        ...
        Public Overridable Function GetAutoCompletionList_SelectorSearch(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim recordList () As IROC2.Business.CommentsRecord = CommentsTable.GetRecords(filterJoin, wc, Nothing, 0, count,count)
            Dim rec As CommentsRecord = Nothing
    ...
    Try
        ...
        Public Overridable Sub AddButton_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../Comments/Add-Comments-Pop-up.aspx"
