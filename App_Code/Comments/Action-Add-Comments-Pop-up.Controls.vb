...
' Action_Add_Comments_Pop_up.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Action_Add_Comments_Pop_up
...
' Base class for the CommentsRecordControl control on the Action_Add_Comments_Pop_up page.
...
Public Class BaseCommentsRecordControl
        ...
        Public Overridable Sub SetComment()
            ...
            Else 
                ...
                Me.Comment.Text = EvaluateFormula("URL(""Comment"")", Me.DataSource)		
                End If
        ...
        Public Overridable Sub SetComment_To_Agency()
            ...
            Else 
                ...
                Me.Comment_To_Agency.Text = EvaluateFormula("URL(""To_Agency"")", Me.DataSource)		
                End If
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in Action-Add-Comments-Pop-up") = recId
