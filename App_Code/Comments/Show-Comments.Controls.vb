...
' Show_Comments.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Show_Comments
...
' Base class for the CommentsRecordControl control on the Show_Comments page.
...
Public Class BaseCommentsRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.CommentsDialogEditButton.Click, AddressOf CommentsDialogEditButton_Click
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in Show-Comments") = recId
        ...
        Public Overridable Sub CommentsDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
       ...
       ' Upon error, rollback the transaction
        ...
        Public Overridable Sub Request_Id_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../Request_Master/Show-Request-Master.aspx?Request_Master={CommentsRecordControl:FK:FK_Comments_Request_Master}"
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property CommentsDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "CommentsDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
