...
' Add_Comments.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Add_Comments
...
' Base class for the CommentsRecordControl control on the Add_Comments page.
...
Public Class BaseCommentsRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in Add-Comments") = recId
        ...
        Protected Overridable Sub Control_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PreRender
			...
			Me.Page.Authorize(Ctype(Request_IdLabel, Control), "1;2;3;4;5")
