...
' Add_Comments_Pop_up.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Add_Comments_Pop_up
...
Public Class CommentsRecordControl
		...
		Public Overrides Sub SetComment_Topic()
            ...
            If EvaluateFormula("URL(""Pending_Agency_Return"")") <> "" Then
                selectedValue = "Info Provided"

            ElseIf Me.DataSource IsNot Nothing AndAlso Me.DataSource.Comment_TopicSpecified Then
...
' Base class for the CommentsRecordControl control on the Add_Comments_Pop_up page.
...
Public Class BaseCommentsRecordControl
        ...
        Public Overridable Sub SetComment_To_Agency()
            ...
            Else 
                ...
                Me.Comment_To_Agency.Text = EvaluateFormula("""Everyone""", Me.DataSource)		
                End If
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in Add-Comments-Pop-up") = recId
        ...
        Protected Overridable Sub PopulateComment_TopicDropDownList( _
            ...
            Me.Comment_Topic.Items.Add(New ListItem(Me.Page.ExpandResourceValue("{Txt:PleaseSelect}"), "--PLEASE_SELECT--"))
                            							
            Me.Comment_Topic.Items.Add(New ListItem(Me.Page.ExpandResourceValue("FYI"), "FYI"))
                            							
            Me.Comment_Topic.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Notes"), "Notes"))
                            							
            Me.Comment_Topic.Items.Add(New ListItem(Me.Page.ExpandResourceValue("Project Notes"), "Project Notes"))
            ...
            If Not selectedValue Is Nothing AndAlso _
                ...
                Not SetSelectedDisplayText(Me.Comment_Topic, selectedValue) AndAlso _
                Not SetSelectedDisplayText(Me.Comment_Topic, CommentsTable.Comment_Topic.Format(selectedValue))Then
                Dim fvalue As String = CommentsTable.Comment_Topic.Format(selectedValue)
                If fvalue Is Nothing OrElse fvalue.Trim() = "" Then fvalue = selectedValue
                ResetSelectedItem(Me.Comment_Topic, New ListItem(fvalue, selectedValue))
            End If					
