...
' Show_Role.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Show_Role
...
' Base class for the UsersTableControlRow control on the Show_Role page.
...
Public Class BaseUsersTableControlRow
      ...
      RegisterRowForHiddenVariableSelection()
        ...
        Public Overridable Sub RegisterRowForHiddenVariableSelection()
            ...
            Dim roleRecordControlObj As RoleRecordControl = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me.Page, "RoleRecordControl"),  IROC2.UI.Controls.Show_Role.RoleRecordControl)     
            ...
            Dim usersTableControlObj As UsersTableControl = DirectCast(MiscUtils.GetParentControlObject(Me, "UsersTableControl"), IROC2.UI.Controls.Show_Role.UsersTableControl)
...
' Base class for the UsersTableControl control on the Show_Role page.
...
' Base class for the RoleRecordControl control on the Show_Role page.
...
Public Class BaseRoleRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.RoleDialogEditButton.Click, AddressOf RoleDialogEditButton_Click
        ...
        Public Overridable Sub SetRole_NameLabel1()
                      ...
                      'Code for the text property is generated inside the .aspx file.
                      'To override this property you can uncomment the following property and add your own value.
                      'Me.Role_NameLabel1.Text = "Some value"
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in Show-Role") = recId
        ...
        ' event handler for ImageButton
        Public Overridable Sub RoleDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property RoleDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RoleDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
