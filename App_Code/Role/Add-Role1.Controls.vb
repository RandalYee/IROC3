...
' Add_Role1.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Add_Role1
...
' Base class for the Users_RoleTableControlRow control on the Add_Role1 page.
...
' Base class for the Users_RoleTableControl control on the Add_Role1 page.
...
Public Class BaseUsers_RoleTableControl
    ...
    End Sub
      ...
      Dim selectedRecordKeyValue as KeyValue = New KeyValue()
              ...
              Dim roleRecordControlObj As IROC2.UI.Controls.Add_Role1.RoleRecordControl = DirectCast(MiscUtils.FindControlRecursively(Me.Page, "RoleRecordControl"), IROC2.UI.Controls.Add_Role1.RoleRecordControl)
...
' Base class for the RoleRecordControl control on the Add_Role1 page.
...
Public Class BaseRoleRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in Add-Role1") = recId
