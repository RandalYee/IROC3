...
' Add_Role.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Add_Role
...
' Base class for the Users_RoleTableControlRow control on the Add_Role page.
...
Public Class BaseUsers_RoleTableControlRow
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Me.Page.LoadFocusScripts(Me)
              ...
              Me.User_ID.PostBackUrl = url & "?Target=" & Me.User_ID.ClientID & "&DFKA=" & CType(Me.Page, BaseApplicationPage).Encrypt("User_Name")& "&IndexField=" & CType(Me.Page, BaseApplicationPage).Encrypt("User_ID")& "&EmptyValue=" & CType(Me.Page, BaseApplicationPage).Encrypt("--PLEASE_SELECT--") & "&EmptyDisplayText=" & CType(Me.Page, BaseApplicationPage).Encrypt(Me.Page.GetResourceValue("Txt:PleaseSelect"))& "&Mode=FieldValueSingleSelection"
              Me.User_ID.Attributes.Item("onClick") = "initializePopupPage(this, '" & Me.User_ID.PostBackUrl & "', false, event); return false;"                  
        ...
        Public Overridable Sub SetUser_ID()
            ...
            If Me.PreviousUIData.ContainsKey(Me.User_ID.ID) Then
                If Me.PreviousUIData(Me.User_ID.ID) Is Nothing
                    selectedValue = Nothing
                Else
                    selectedValue = Me.PreviousUIData(Me.User_ID.ID).ToString()
                End If
            End If
            
        
            ' Set the User_ID QuickSelector on the webpage with value from the
            ...
            ' Me.User_ID is the ASP:QuickSelector on the webpage.
            ...
            Else
                ...
                If Me.DataSource IsNot Nothing AndAlso Me.DataSource.IsCreated Then
                    selectedValue = Nothing
                Else
                    selectedValue = Users_RoleTable.User_ID.DefaultValue
                End If
            ...
            If selectedValue Is Nothing OrElse selectedValue = ""  Then
                  MiscUtils.ResetSelectedItem(Me.User_ID, New ListItem(Me.Page.GetResourceValue("Txt:PleaseSelect", "IROC2"), "--PLEASE_SELECT--"))
            End If              
            ...
            Me.User_ID.SetFieldMaxLength(50)
        ...
        Dim parentCtrl As RoleRecordControl
          ...
          If (Not IsNothing(parentCtrl) AndAlso IsNothing(parentCtrl.DataSource)) 
            ...
            Me.DataSource.Role_ID = parentCtrl.DataSource.Role_ID
        ...
        Public Overridable Sub GetUser_ID()
            ...
            ' Retrieve the value entered by the user on the User_ID ASP:QuickSelector, and
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If(Not Me.Page.IsPageRefresh) Then
                ...
                Dim tc As Users_RoleTableControl = DirectCast(GetParentControlObject(Me, "Users_RoleTableControl"), Users_RoleTableControl)
                If Not (IsNothing(tc)) Then
                    If Not Me.IsNewRecord Then
                        tc.AddToDeletedRecordIds(DirectCast(Me, Users_RoleTableControlRow))
                    End If
                    Me.Visible = False
...
#Region "Helper Properties"
              ...
              Public ReadOnly Property User_ID() As BaseClasses.Web.UI.WebControls.QuickSelector
                  Get
                      Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "User_ID"), BaseClasses.Web.UI.WebControls.QuickSelector)
              End Get
              End Property
            
        Public ReadOnly Property Users_RoleRecordRowSelection() As System.Web.UI.WebControls.CheckBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Users_RoleRecordRowSelection"), System.Web.UI.WebControls.CheckBox)
            End Get
        End Property
...
' Base class for the Users_RoleTableControl control on the Add_Role page.
...
Public Class BaseUsers_RoleTableControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            SaveControlsToSession_Ajax()
              ...
              ' Show confirmation message on Click
              Me.Users_RoleDeleteButton.Attributes.Add("onClick", "return (confirm(""" & (CType(Me.Page,BaseApplicationPage)).GetResourceValue("DeleteConfirm", "IROC2") & """));")
            ...
            ' Setup the button events.
              ...
              AddHandler Me.Users_RoleAddButton.Click, AddressOf Users_RoleAddButton_Click
              
              AddHandler Me.Users_RoleDeleteButton.Click, AddressOf Users_RoleDeleteButton_Click
    ...
    End Sub
      ...
      Dim selectedRecordKeyValue as KeyValue = New KeyValue()
              ...
              Dim roleRecordControlObj As IROC2.UI.Controls.Add_Role.RoleRecordControl = DirectCast(MiscUtils.FindControlRecursively(Me.Page, "RoleRecordControl"), IROC2.UI.Controls.Add_Role.RoleRecordControl)
              
                If (Not IsNothing(roleRecordControlObj) AndAlso Not IsNothing(roleRecordControlObj.GetRecord()) AndAlso roleRecordControlObj.GetRecord().IsCreated AndAlso Not IsNothing(roleRecordControlObj.GetRecord().Role_ID))
                    wc.iAND(Users_RoleTable.Role_ID, BaseFilter.ComparisonOperator.EqualsTo, roleRecordControlObj.GetRecord().Role_ID.ToString())
                    selectedRecordKeyValue.AddElement(Users_RoleTable.Role_ID.InternalName, roleRecordControlObj.GetRecord().Role_ID.ToString())
                Else
                    wc.RunQuery = False
                    Return wc
                End If
              
      HttpContext.Current.Session("Users_RoleTableControlWhereClause") = selectedRecordKeyValue.ToXmlString()
    ...
    End Function
      ...
      Dim appRelativeVirtualPath As String = CType(HttpContext.Current.Session("AppRelativeVirtualPath"), String)
            ...
            Dim selectedRecordInRoleRecordControl as String = DirectCast(HttpContext.Current.Session("Users_RoleTableControlWhereClause"), String)
       ...
       If Not IsNothing(selectedRecordKeyValue) AndAlso selectedRecordKeyValue.ContainsColumn(Users_RoleTable.Role_ID) Then
            wc.iAND(Users_RoleTable.Role_ID, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(Users_RoleTable.Role_ID).ToString())
       End If
    ...
    Dim recControl As Users_RoleTableControlRow = DirectCast(repItem.FindControl("Users_RoleTableControlRow"), Users_RoleTableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        If MiscUtils.IsValueSelected(recControl.User_ID) Then
                            rec.Parse(recControl.User_ID.SelectedItem.Value, Users_RoleTable.User_ID)
                        End If
    ...
    Try
        ...
        ' event handler for ImageButton
        Public Overridable Sub Users_RoleAddButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
       ...
       ' Upon error, rollback the transaction
        ...
        ' event handler for ImageButton
        Public Overridable Sub Users_RoleDeleteButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Users_RoleAddButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Users_RoleAddButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Users_RoleDeleteButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Users_RoleDeleteButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property Users_RoleToggleAll() As System.Web.UI.WebControls.CheckBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Users_RoleToggleAll"), System.Web.UI.WebControls.CheckBox)
            End Get
        End Property
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetSelectedRecordIndex() As Integer
            ...
            Dim recControl As Users_RoleTableControlRow
            For Each recControl In Me.GetRecordControls()
                If recControl.Users_RoleRecordRowSelection.Checked Then
                    Return counter
                End If
                counter += 1
            Next
        ...
        Public Overridable Function GetSelectedRecordControl() As Users_RoleTableControlRow
            Dim selectedList() As Users_RoleTableControlRow = Me.GetSelectedRecordControls()
        ...
        Public Overridable Function GetSelectedRecordControls() As Users_RoleTableControlRow()
            ...
            Dim recControl As Users_RoleTableControlRow
            For Each recControl In Me.GetRecordControls()
                If recControl.Users_RoleRecordRowSelection IsNot Nothing AndAlso recControl.Users_RoleRecordRowSelection.Checked Then
                    selectedList.Add(recControl)
                End If
            Next
            Return DirectCast(selectedList.ToArray(GetType(Users_RoleTableControlRow)), Users_RoleTableControlRow())
        ...
        Public Overridable Sub DeleteSelectedRecords(ByVal deferDeletion As Boolean)
            ...
            For Each recCtl In recList
                If deferDeletion Then
                    ...
                    recCtl.Users_RoleRecordRowSelection.Checked = False
...
' Base class for the RoleRecordControl control on the Add_Role page.
...
Public Class BaseRoleRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(RoleRecord.Copy(recList(0), False), RoleRecord)
        ...
        Dim recUsers_RoleTableControl as Users_RoleTableControl = DirectCast(MiscUtils.FindControlRecursively(Me.Page, "Users_RoleTableControl"), Users_RoleTableControl)
        
            If (shouldResetControl OrElse Me.Page.IsPageRefresh)
              recUsers_RoleTableControl.ResetControl()
            End IF
        
        recUsers_RoleTableControl.LoadData()
        recUsers_RoleTableControl.DataBind()
        ...
        Public Overridable Sub SetRole_EmailLabel()
                      ...
                      'Me.Role_EmailLabel.Text = "Some value"
        ...
        Public Overridable Sub SetRole_NameLabel()
                      ...
                      'Code for the text property is generated inside the .aspx file.
                      'To override this property you can uncomment the following property and add your own value.
                      'Me.Role_NameLabel.Text = "Some value"
        ...
        Dim recUsers_RoleTableControl as Users_RoleTableControl = DirectCast(MiscUtils.FindControlRecursively(Me.Page, "Users_RoleTableControl"), Users_RoleTableControl)
        recUsers_RoleTableControl.SaveData()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Dim recId As String = Me.Page.Request.QueryString.Item("Role")
            ...
            HttpContext.Current.Session("QueryString in Add-Role") = recId
