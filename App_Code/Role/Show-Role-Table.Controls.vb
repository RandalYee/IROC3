...
' Show_Role_Table.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Show_Role_Table
...
' Base class for the RoleTableControlRow control on the Show_Role_Table page.
...
' Base class for the RoleTableControl control on the Show_Role_Table page.
...
Public Class BaseRoleTableControl
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Role-Table.RolePDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Role"
                ' If Show-Role-Table.RolePDFButton.report specifies a valid report template,
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Role-Table.RoleWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Role"
                ' If Show-Role-Table.RoleWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
