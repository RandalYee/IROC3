...
' Edit_Role.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Edit_Role
...
' Base class for the UsersTableControlRow control on the Edit_Role page.
...
Public Class BaseUsersTableControlRow
      ...
      RegisterRowForHiddenVariableSelection()
        ...
        Public Overridable Sub RegisterRowForHiddenVariableSelection()
            ...
            Dim roleRecordControlObj As RoleRecordControl = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me.Page, "RoleRecordControl"),  IROC2.UI.Controls.Edit_Role.RoleRecordControl)     
            ...
            Dim usersTableControlObj As UsersTableControl = DirectCast(MiscUtils.GetParentControlObject(Me, "UsersTableControl"), IROC2.UI.Controls.Edit_Role.UsersTableControl)
...
' Base class for the UsersTableControl control on the Edit_Role page.
...
' Base class for the RoleRecordControl control on the Edit_Role page.
...
Public Class BaseRoleRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in Edit-Role") = recId
