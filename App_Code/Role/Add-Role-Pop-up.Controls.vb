...
' Add_Role_Pop_up.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Add_Role_Pop_up
...
' Base class for the RoleRecordControl control on the Add_Role_Pop_up page.
...
Public Class BaseRoleRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in Add-Role-Pop-up") = recId
