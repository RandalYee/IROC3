...
' Show_Enity.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Show_Enity
...
' Base class for the EnityRecordControl control on the Show_Enity page.
...
Public Class BaseEnityRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.EnityDialogEditButton.Click, AddressOf EnityDialogEditButton_Click
        ...
        Public Overridable Sub SetEnity_Type()
            ...
            ' Set the Enity_Type Literal on the webpage with value from the
            ' DatabaseIROC%dbo.Enity database record.

            ' Me.DataSource is the DatabaseIROC%dbo.Enity record retrieved from the database.
            ' Me.Enity_Type is the ASP:Literal on the webpage.
            ...
            ' If the Enity_Type is NULL or blank, then use the value specified  
            ' on Properties.
            If Me.Enity_Type.Text Is Nothing _
                OrElse Me.Enity_Type.Text.Trim() = "" Then
                ' Set the value specified on the Properties.
                Me.Enity_Type.Text = "&nbsp;"
            End If
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            ' Retrieve the record id from the URL parameter.
                  ...
                  Dim recId As String = DirectCast(Me.Page, BaseApplicationPage).Decrypt(Me.Page.Request.QueryString.Item("Enity"))
                
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "IROC2").Replace("{URL}", "Enity"))
            End If
            HttpContext.Current.Session("QueryString in Show-Enity") = recId
        ...
        Public Overridable Sub EnityDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Enity_Type() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Enity_Type"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
        ...
        Public ReadOnly Property EnityDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "EnityDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
