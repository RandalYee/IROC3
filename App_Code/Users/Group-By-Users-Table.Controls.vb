...
' Group_By_Users_Table.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Group_By_Users_Table
...
' Base class for the RoleTableControlRow control on the Group_By_Users_Table page.
...
Public Class BaseRoleTableControlRow
      ...
      RegisterRowForHiddenVariableSelection()
        ...
        Public Overridable Sub RegisterRowForHiddenVariableSelection()
            ...
            Dim usersTableControlRowObj As UsersTableControlRow = DirectCast(MiscUtils.GetParentControlObject(Me,  "UsersTableControlRow"), IROC2.UI.Controls.Group_By_Users_Table.UsersTableControlRow)         
	            
            Dim Id As String = ""
            If (Not IsNothing(usersTableControlRowObj) AndAlso Not IsNothing(usersTableControlRowObj.GetRecord()) AndAlso usersTableControlRowObj.GetRecord().IsCreated()) Then
               Id = usersTableControlRowObj.GetRecord().GetID().ToXmlString()
            End If 
                          
            Dim roleTableControlObj As RoleTableControl = DirectCast(MiscUtils.GetParentControlObject(Me, "RoleTableControl"), IROC2.UI.Controls.Group_By_Users_Table.RoleTableControl)
...
' Base class for the RoleTableControl control on the Group_By_Users_Table page.
    ...
    End Sub
      ...
      Public Overridable Function GetParentControlPrimaryKey() As String
            ...
            If (Not IsNothing(usersTableControlRowObj) AndAlso Not IsNothing(usersTableControlRowObj.GetRecord()) AndAlso (usersTableControlRowObj.GetRecord().IsCreated)) Then
              ...
              id = usersTableControlRowObj.GetRecord().User_ID.ToString()
...
' Base class for the UsersTableControlRow control on the Group_By_Users_Table page.
...
Public Class BaseUsersTableControlRow
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Me.Page.LoadFocusScripts(Me)
              ...
              Me.UsersRowDeleteButton.Attributes.Add("onClick", "return (confirm(""" & (CType(Me.Page,BaseApplicationPage)).GetResourceValue("DeleteRecordConfirm", "IROC2") & """));")
              ...
              AddHandler Me.UsersRowExpandCollapseRowButton.Click, AddressOf UsersRowExpandCollapseRowButton_Click
        ...
        Public Overrides Sub DataBind()
            ...
            Dim recRoleTableControl as RoleTableControl = DirectCast(MiscUtils.FindControlRecursively(Me, "RoleTableControl"), RoleTableControl)
            recRoleTableControl.LoadData()
            recRoleTableControl.DataBind()
       ...
       ' Upon error, rollback the transaction
        ...
        Public Overridable Sub UsersRowEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../Users/Edit-Users.aspx?Users={PK}"
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
       ...
       ' Upon error, rollback the transaction
        ...
        ' event handler for ImageButton
        Public Overridable Sub UsersRowExpandCollapseRowButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        
    Try
    
          Dim panelControl as UsersTableControl = DirectCast(MiscUtils.GetParentControlObject(Me, "UsersTableControl"), UsersTableControl)

          Dim repeatedRows() as UsersTableControlRow = panelControl.GetRecordControls()
          For Each repeatedRow as UsersTableControlRow in repeatedRows
              Dim altRow as System.Web.UI.Control= DirectCast(MiscUtils.FindControlRecursively(repeatedRow, "UsersTableControlAltRow"), System.Web.UI.Control)
              If (altRow IsNot Nothing) Then
                  If (sender Is repeatedRow.UsersRowExpandCollapseRowButton) Then
                      altRow.Visible = Not altRow.Visible
                  
                  End If                      
                  If (altRow.Visible) Then        
                   
                     repeatedRow.UsersRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif"
                     repeatedRow.UsersRowExpandCollapseRowButton.Attributes.Add("onmouseover", "this.src='../Images/icon_expandcollapserow_over.gif'")
                     repeatedRow.UsersRowExpandCollapseRowButton.Attributes.Add("onmouseout", "this.src='../Images/icon_expandcollapserow.gif'")
                                     
                  Else
                   
                     repeatedRow.UsersRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif"
                     repeatedRow.UsersRowExpandCollapseRowButton.Attributes.Add("onmouseover", "this.src='../Images/icon_expandcollapserow_over2.gif'")
                     repeatedRow.UsersRowExpandCollapseRowButton.Attributes.Add("onmouseout", "this.src='../Images/icon_expandcollapserow2.gif'")
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property RoleTableControl() As RoleTableControl
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RoleTableControl"), RoleTableControl)
            End Get
        End Property
        ...
        Public ReadOnly Property UsersRowExpandCollapseRowButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UsersRowExpandCollapseRowButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
...
' Base class for the UsersTableControl control on the Group_By_Users_Table page.
...
Public Class BaseUsersTableControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            ' Setup the button events.
              ...
              Me.UsersImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Users" 
              Me.UsersImportButton.Attributes.Item("onClick") = "window.open('" & Me.Page.EncryptUrlParameter(Me.UsersImportButton.PostBackUrl) & "','importWindow', 'width=700, height=500,top=' +(screen.availHeight-500)/2 + ',left=' + (screen.availWidth-700)/2+ ', resizable=yes, scrollbars=yes,modal=yes'); return false;"
        ...
        Public Overrides Sub DataBind()
          ...
          Next
            ...
            Dim recControls() As UsersTableControlRow = Me.GetRecordControls()
            For i As Integer = 0 to recControls.Length - 1
                Dim altRow As System.Web.UI.Control = DirectCast(MiscUtils.FindControlRecursively(recControls(i), "UsersTableControlAltRow"), System.Web.UI.Control)
                If (altRow IsNot Nothing) Then
                    If (expandFirstRow AndAlso i = 0) Then                
                        altRow.Visible = True
                   
                         recControls(i).UsersRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow.gif"
                         recControls(i).UsersRowExpandCollapseRowButton.Attributes.Add("onmouseover", "this.src='../Images/icon_expandcollapserow_over.gif'")
                         recControls(i).UsersRowExpandCollapseRowButton.Attributes.Add("onmouseout", "this.src='../Images/icon_expandcollapserow.gif'")
                   
                    Else                
                        altRow.Visible = False
                   
                         recControls(i).UsersRowExpandCollapseRowButton.ImageUrl = "../Images/icon_expandcollapserow2.gif"
                         recControls(i).UsersRowExpandCollapseRowButton.Attributes.Add("onmouseover", "this.src='../Images/icon_expandcollapserow_over2.gif'")
                         recControls(i).UsersRowExpandCollapseRowButton.Attributes.Add("onmouseout", "this.src='../Images/icon_expandcollapserow2.gif'")
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            ' Create the Order By clause based on the user's current sorting preference.
              ...
              Me.TotalRecords = UsersTable.GetRecordCount(join, wc)
              If Me.TotalRecords > 10000 Then
          
              ' Add each of the columns in order of export.
              Dim columns() as BaseColumn = New BaseColumn() { _
                         UsersTable.User_Name, _ 
             UsersTable.Email, _ 
             UsersTable.IsActive, _ 
             Nothing}
              ...
              Dim dataForCSV As DataForExport = New DataForExport(UsersTable.Instance, wc, orderBy, columns, join)
          ...
          Else
              ...
              Dim data As DataForExport = New DataForExport(UsersTable.Instance, wc, orderBy, Nothing, join)
                       data.ColumnList.Add(New ExcelColumn(UsersTable.User_Name, "Default"))
             data.ColumnList.Add(New ExcelColumn(UsersTable.Email, "Default"))
             data.ColumnList.Add(New ExcelColumn(UsersTable.IsActive, "Default"))
                  ...
                  For Each rec As BaseRecord In recList
                      ...
                      For Each col As ExcelColumn In data.ColumnList
                          ...
                          If _isExpandableNonCompositeForeignKey AndAlso col.DisplayColumn.IsApplyDisplayAs Then
                              val = UsersTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, Nothing)
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Group-By-Users-Table.UsersPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users"
                ' If Group-By-Users-Table.UsersPDFButton.report specifies a valid report template,
                ...
                ' The 5th parameter represents the relative width of the column   			
                 report.AddColumn(UsersTable.User_Name.Name, ReportEnum.Align.Left, "${User_Name}", ReportEnum.Align.Left, 30)
                 report.AddColumn(UsersTable.Email.Name, ReportEnum.Align.Left, "${Email}", ReportEnum.Align.Left, 30)
                 report.AddColumn(UsersTable.IsActive.Name, ReportEnum.Align.Left, "${IsActive}", ReportEnum.Align.Left, 15)
              ...
              Dim joinFilter As BaseFilter = CreateCompoundJoinFilter()
                ...
                Dim pageNum As Integer = 0 
                Dim totalRows As Integer = UsersTable.GetRecordCount(joinFilter,whereClause)
                Dim columns As ColumnList = UsersTable.GetColumnList()
                Dim records As UsersRecord() = Nothing
            
                Do 
                    
                    records = UsersTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery)
                    If Not (records Is Nothing) AndAlso records.Length > 0 AndAlso whereClause.RunQuery Then
                      For Each record As UsersRecord In records 
                            ...
                            ' The 4th parameters represent the maximum length of the data value being shown
                                                         report.AddData("${User_Name}", record.Format(UsersTable.User_Name), ReportEnum.Align.Left, 300)
                             report.AddData("${Email}", record.Format(UsersTable.Email), ReportEnum.Align.Left, 300)
                             report.AddData("${IsActive}", record.Format(UsersTable.IsActive), ReportEnum.Align.Left, 300)
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Group-By-Users-Table.UsersWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users"
                ' If Group-By-Users-Table.UsersWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetSelectedRecordControls() As UsersTableControlRow()
            ...
            Return DirectCast((new ArrayList()).ToArray(GetType(UsersTableControlRow)), UsersTableControlRow())
