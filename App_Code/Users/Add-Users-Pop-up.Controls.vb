...
' Add_Users_Pop_up.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Add_Users_Pop_up
...
' Base class for the UsersRecordControl control on the Add_Users_Pop_up page.
...
Public Class BaseUsersRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(UsersRecord.Copy(recList(0), False), UsersRecord)
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in Add-Users-Pop-up") = recId
