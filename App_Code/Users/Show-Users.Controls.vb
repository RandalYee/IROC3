...
' Show_Users.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Show_Users
...
' Base class for the RoleTableControlRow control on the Show_Users page.
...
Public Class BaseRoleTableControlRow
      ...
      RegisterRowForHiddenVariableSelection()
        ...
        Public Overridable Sub RegisterRowForHiddenVariableSelection()
            ...
            Dim usersRecordControlObj As UsersRecordControl = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me.Page, "UsersRecordControl"),  IROC2.UI.Controls.Show_Users.UsersRecordControl)     
            ...
            Dim roleTableControlObj As RoleTableControl = DirectCast(MiscUtils.GetParentControlObject(Me, "RoleTableControl"), IROC2.UI.Controls.Show_Users.RoleTableControl)
...
' Base class for the RoleTableControl control on the Show_Users page.
...
' Base class for the UsersRecordControl control on the Show_Users page.
...
Public Class BaseUsersRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in Show-Users") = recId
        ...
        ' event handler for ImageButton
        Public Overridable Sub UsersDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property UsersDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UsersDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
