...
' Show_Franchise_Number.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Show_Franchise_Number
...
' Base class for the Franchise_NumberRecordControl control on the Show_Franchise_Number page.
...
Public Class BaseFranchise_NumberRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.Franchise_NumberDialogEditButton.Click, AddressOf Franchise_NumberDialogEditButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "Franchise_NumberRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Me.DataSource = Franchise_NumberTable.GetRecord(recList(0).GetID.ToXmlString(), True)
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            ' Retrieve the record id from the URL parameter.
                  ...
                  Dim recId As String = DirectCast(Me.Page, BaseApplicationPage).Decrypt(Me.Page.Request.QueryString.Item("Franchise_Number"))
                
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "IROC2").Replace("{URL}", "Franchise_Number"))
            End If
            HttpContext.Current.Session("QueryString in Show-Franchise-Number") = recId
        ...
        Public Overridable Sub Franchise_NumberDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Franchise_NumberDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Franchise_NumberDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
