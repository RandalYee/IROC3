...
' Show_Franchise_Number_Table.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Show_Franchise_Number_Table
...
' Base class for the Franchise_NumberTableControlRow control on the Show_Franchise_Number_Table page.
...
' Base class for the Franchise_NumberTableControl control on the Show_Franchise_Number_Table page.
...
Public Class BaseFranchise_NumberTableControl
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Franchise-Number-Table.Franchise_NumberPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Franchise_Number"
                ' If Show-Franchise-Number-Table.Franchise_NumberPDFButton.report specifies a valid report template,
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Franchise-Number-Table.Franchise_NumberWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Franchise_Number"
                ' If Show-Franchise-Number-Table.Franchise_NumberWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
