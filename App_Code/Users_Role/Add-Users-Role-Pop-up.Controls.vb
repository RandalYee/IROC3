...
' Add_Users_Role_Pop_up.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Add_Users_Role_Pop_up
...
' Base class for the Users_RoleRecordControl control on the Add_Users_Role_Pop_up page.
...
Public Class BaseUsers_RoleRecordControl
        ...
        Public Overridable Sub SetRole_ID()
            ...
            Else
                ...
                selectedValue = EvaluateFormula("URL(""Role_ID"")")
            End If
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in Add-Users-Role-Pop-up") = recId
