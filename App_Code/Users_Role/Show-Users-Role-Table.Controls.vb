...
' Show_Users_Role_Table.aspx page.  The Row or RecordControl classes are the 
...
Namespace IROC2.UI.Controls.Show_Users_Role_Table
...
' Base class for the Users_RoleTableControlRow control on the Show_Users_Role_Table page.
...
Public Class BaseUsers_RoleTableControlRow
        ...
        Public Overridable Sub SetLiteral()
                      ...
                      Me.Literal.Text = EvaluateFormula("GetColumnValue(""Role"", Role_ID, ""Role_Name"")")
                    
                  End Sub
                
        Public Overridable Sub SetUser_Literal()
                  
                      Me.User_Literal.Text = EvaluateFormula("GetColumnValue(""Users"", User_ID, ""User_Name"")")
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property User_Literal() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "User_Literal"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
...
' Base class for the Users_RoleTableControl control on the Show_Users_Role_Table page.
...
Public Class BaseUsers_RoleTableControl
    ...
    Dim recControl As Users_RoleTableControlRow = DirectCast(repItem.FindControl("Users_RoleTableControlRow"), Users_RoleTableControlRow)
        ...
        Public Overridable Sub SetRoleRecordControlLabel()
                  
                      'Code for the text property is generated inside the .aspx file.
                      'To override this property you can uncomment the following property and add your own value.
                      'Me.RoleRecordControlLabel.Text = "Some value"
                    
                  End Sub
                
        Public Overridable Sub SetUsersRecordControlLabel()
                  
                      'Code for the text property is generated inside the .aspx file.
                      'To override this property you can uncomment the following property and add your own value.
                      'Me.UsersRecordControlLabel.Text = "Some value"
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Users-Role-Table.Users_RolePDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Role"
                ' If Show-Users-Role-Table.Users_RolePDFButton.report specifies a valid report template,
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Users-Role-Table.Users_RoleWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users_Role"
                ' If Show-Users-Role-Table.Users_RoleWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property RoleRecordControlLabel() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RoleRecordControlLabel"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
        ...
        Public ReadOnly Property UsersRecordControlLabel() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UsersRecordControlLabel"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
