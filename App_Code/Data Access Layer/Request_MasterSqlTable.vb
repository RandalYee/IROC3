...
Namespace IROC2.Data
	...
	''' <summary>
	''' Used by the <see cref="Request_MasterTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Request_MasterSqlTable
		Inherits BaseRequest_MasterSqlTable
