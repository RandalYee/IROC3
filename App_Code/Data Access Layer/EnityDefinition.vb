...
''' <see cref="EnityTable">IROC2.EnityTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="EnityTable"></seealso>

Public Class EnityDefinition

#Region "Definition (XML) for EnityDefinition table"
	'Next 161 lines contain Table Definition (XML) for table "EnityDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="EnityTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>Enity_ID</columnName>")
         ...
         tbf.Append(      "<columnName>Enity_Codes</columnName>")
         tbf.Append(      "<columnUIName>Enity Codes</columnUIName>")
         ...
         tbf.Append(      "<columnName>DeptAgencyNames</columnName>")
         tbf.Append(      "<columnUIName>Department Agency Names</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>nvarchar</columnDBType>")
         ...
         tbf.Append(      "<columnName>Enity_Type</columnName>")
         tbf.Append(      "<columnUIName>Enity Type</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>Enity</TableName>")
         tbf.Append(  "<Version>1</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>Enity_</TableAliasName>")
         ...
         tbf.Append(  "<TableCodeName>Enity</TableCodeName>")
         tbf.Append(  "<FolderName>Enity</FolderName>")
         tbf.Append(  "<MenuName>Enity</MenuName>")
         tbf.Append(  "<QSPath>../Enity/Enity-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableStoredProcPrefix>pIROC2Enity</TableStoredProcPrefix>")
