...
Namespace IROC2.Data
	...
	''' <summary>
	''' Used by the <see cref="Franchise_NumberTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Franchise_NumberSqlTable
		Inherits BaseFranchise_NumberSqlTable
