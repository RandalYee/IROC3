...
''' <see cref="Franchise_NumberTable">IROC2.Franchise_NumberTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Franchise_NumberTable"></seealso>

Public Class Franchise_NumberDefinition

#Region "Definition (XML) for Franchise_NumberDefinition table"
	'Next 73 lines contain Table Definition (XML) for table "Franchise_NumberDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Franchise_NumberTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>Franchise_ID</columnName>")
         tbf.Append(      "<columnUIName>Franchise</columnUIName>")
         ...
         tbf.Append(      "<columnName>Franchise_Order_Number</columnName>")
         tbf.Append(      "<columnUIName>Franchise Order Number</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>Franchise_Number</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>Franchise_Number_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>Franchise_Number</FolderName>")
         tbf.Append(  "<MenuName>Franchise Number</MenuName>")
         tbf.Append(  "<QSPath>../Franchise_Number/Franchise-Number-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Franchise_Number</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pIROC2Franchise_Number</TableStoredProcPrefix>")
