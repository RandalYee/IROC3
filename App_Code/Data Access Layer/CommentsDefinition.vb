...
''' <see cref="CommentsTable">IROC2.CommentsTable</see> class
...
#Region "Definition (XML) for CommentsDefinition table"
	'Next 360 lines contain Table Definition (XML) for table "CommentsDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="CommentsTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>Comment_ID</columnName>")
         ...
         tbf.Append(        "<columnFKName>FK_Comments_Request_Master</columnFKName>")
         ...
         tbf.Append(      "<columnName>Comment_To_Agency</columnName>")
         tbf.Append(      "<columnUIName>Comment To Agency</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>nvarchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>10</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>Comment_Topic</columnName>")
         tbf.Append(      "<columnUIName>Comment Topic</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>nvarchar</columnDBType>")
         ...
         tbf.Append(      "<columnName>Comment_Dt</columnName>")
         tbf.Append(      "<columnUIName>Comment DT</columnUIName>")
         ...
         tbf.Append(      "<columnName>Email_Out</columnName>")
         tbf.Append(      "<columnUIName>Email Out</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>Comments</TableName>")
         tbf.Append(  "<Version>2</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>Comments_</TableAliasName>")
         ...
         tbf.Append(  "<TableCodeName>Comments</TableCodeName>")
         tbf.Append(  "<FolderName>Comments</FolderName>")
         tbf.Append(  "<MenuName>Comments</MenuName>")
         tbf.Append(  "<QSPath>../Comments/Comments-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableStoredProcPrefix>pIROC2Comments</TableStoredProcPrefix>")
