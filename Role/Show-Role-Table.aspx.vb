...
' This file implements the code-behind class for Show_Role_Table.aspx.
' App_Code\Show_Role_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Role_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_Role_Table page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_RoleSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Show_Role_Table.RoleTableControl 
            control = new IROC2.UI.Controls.Show_Role_Table.RoleTableControl()
