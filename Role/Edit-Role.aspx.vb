...
' This file implements the code-behind class for Edit_Role.aspx.
' App_Code\Edit_Role.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Edit_Role
        Inherits BaseApplicationPage
' Code-behind class for the Edit_Role page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_UsersSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Edit_Role.UsersTableControl 
            control = new IROC2.UI.Controls.Edit_Role.UsersTableControl()
