...
' This file implements the code-behind class for Show_Role.aspx.
' App_Code\Show_Role.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Role
        Inherits BaseApplicationPage
' Code-behind class for the Show_Role page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_UsersSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Show_Role.UsersTableControl 
            control = new IROC2.UI.Controls.Show_Role.UsersTableControl()
