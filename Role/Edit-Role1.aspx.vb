...
' This file implements the code-behind class for Edit_Role1.aspx.
' App_Code\Edit_Role1.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Edit_Role1
        Inherits BaseApplicationPage
' Code-behind class for the Edit_Role1 page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Role"
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_UsersSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Edit_Role1.UsersTableControl 
            control = new IROC2.UI.Controls.Edit_Role1.UsersTableControl()
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
           ...
           Dim id As String = ""
            ...
            If target <> "" AndAlso field <> "" Then
                  ...
                  If Not Me.RoleRecordControl Is Nothing AndAlso Not Me.RoleRecordControl.DataSource Is Nothing Then
                        id = Me.RoleRecordControl.DataSource.GetValue(Me.RoleRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString
                        If formula <> "" Then
                            Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                            variables.Add(Me.RoleRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.RoleRecordControl.DataSource)
                            value = EvaluateFormula(formula, Me.RoleRecordControl.DataSource, Nothing,variables)
                        ElseIf displayFieldName = "" Then
                            value = id
                        Else
                            value = Me.RoleRecordControl.DataSource.GetValue(Me.RoleRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString
                        End If
                  End If
