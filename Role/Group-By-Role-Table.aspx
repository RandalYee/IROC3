...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Group-By-Role-Table.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IROC2.UI.Group_By_Role_Table" %>
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Group_By_Role_Table" %>
...
<tr><td class="ticnb" scope="row">
                          ...
                          <asp:ImageButton runat="server" id="RoleRowDeleteButton" causesvalidation="False" commandname="DeleteRecord" cssclass="button_link" imageurl="../Images/icon_delete.gif" onmouseout="this.src='../Images/icon_delete.gif'" onmouseover="this.src='../Images/icon_delete_over.gif'" requiredroles="&lt;PRoles>1&lt;/PRoles>" tooltip="&lt;%# GetResourceValue(&quot;Txt:DeleteRecord&quot;, &quot;IROC2&quot;) %>">		
	</asp:ImageButton>
                        </td><td class="ttc"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="Role_ID"></asp:Literal></span>
</td><td class="ttc"><asp:Literal runat="server" id="Role_Name"></asp:Literal></td><td class="ttc"><asp:Literal runat="server" id="Role_Email"></asp:Literal></td></tr><tr id="RoleTableControlAltRow" runat="server"><td class="ticnb" scope="row">&nbsp;</td><td class="ticnb" scope="row">&nbsp;</td><td class="ticnb" scope="row">&nbsp; 
</td><td class="ttc"><asp:TabContainer runat="server" id="RoleTabContainer">
 <asp:TabPanel runat="server" id="UsersTabPanel" HeaderText="Role Users">	<ContentTemplate>
  <IROC2:UsersTableControl runat="server" id="UsersTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td></td><td></td><td></td></tr><tr><td></td><td>
...
</asp:TabContainer></td><td class="ttc" colspan="1"></td><td class="ttc"></td></tr></IROC2:RoleTableControlRow>
</ITEMTEMPLATE>
