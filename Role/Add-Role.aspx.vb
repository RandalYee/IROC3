...
' This file implements the code-behind class for Add_Role.aspx.
' App_Code\Add_Role.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Add_Role
        Inherits BaseApplicationPage
' Code-behind class for the Add_Role page.
