...
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Show_Role" %>
...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Role.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IROC2.UI.Show_Role" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle"><table cellpadding="0" cellspacing="0" border="0"><tr><td><asp:Literal runat="server" id="RoleTitle" Text="(&quot;Title:Show&quot;),&quot; Role (Type, Enitity)&quot;) %>">	</asp:Literal></td><td class="dhir"><asp:ImageButton runat="server" id="RoleDialogEditButton" causesvalidation="False" commandname="Redirect" imageurl="../Images/iconEdit.gif" onmouseout="this.src='../Images/iconEdit.gif'" onmouseover="this.src='../Images/iconEditOver.gif'" tooltip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;IROC2&quot;) %>">		
...
</td></tr><tr><td class="fls"><asp:Literal runat="server" id="Role_NameLabel" Text="Role_Name (Type, Entity): ">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="Role_Name"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="Role_NameLabel1" Text="Role_Name:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="Role_Email"></asp:Literal></td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
