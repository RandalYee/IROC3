...
' This file implements the code-behind class for Role_QuickSelector.aspx.
' App_Code\Role_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Role_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the Role_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_SelectorSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Role_QuickSelector.SelectorTableControl 
            control = new IROC2.UI.Controls.Role_QuickSelector.SelectorTableControl()
