...
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Edit_Contacts" %>

<%@ Register Tagprefix="IROC2" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Edit-Contacts.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IROC2.UI.Edit_Contacts" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <asp:panel id="ContactsRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="ContactsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="fls"><asp:Literal runat="server" id="AgencyLabel" Text="Agency:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="Agency"></asp:Literal></td><td class="fls"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="TypeLabel" Text="Type: *">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
<asp:DropDownList runat="server" id="Type0" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList>&nbsp;
<asp:RequiredFieldValidator runat="server" id="Type0RequiredFieldValidator" ControlToValidate="Type0" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueIsRequired&quot;, &quot;IROC2&quot;).Replace(&quot;{FieldName}&quot;, &quot;Type&quot;) %>" enabled="True" text="*"></asp:RequiredFieldValidator></span>
</td><td class="dfv"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="TitleLabel" Text="Title:">	</asp:Literal></td><td class="dfv" colspan="3"><span style="white-space:nowrap;">
<asp:TextBox runat="server" id="Title" MaxLength="255" columns="120" cssclass="field_input" rows="0" textmode="SingleLine"></asp:TextBox>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="TitleTextBoxMaxLengthValidator" ControlToValidate="Title" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IROC2&quot;).Replace(&quot;{FieldName}&quot;, &quot;Title&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td></tr><tr><td class="fls"><asp:Literal runat="server" id="NameLabel" Text="Name: *">	</asp:Literal></td><td class="dfv" colspan="3"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="fls"><asp:Literal runat="server" id="EmailLabel" Text="Email: *">	</asp:Literal></td><td class="dfv" colspan="3"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="fls"><asp:Literal runat="server" id="Work_PhoneLabel" Text="Work Phone: *">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
...
</td><td class="dfv"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="MobileLabel" Text="Mobile Phone:">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
...
<asp:TextBox runat="server" id="Address" MaxLength="255" columns="120" cssclass="field_input" rows="0" textmode="SingleLine"></asp:TextBox>&nbsp;
...
<asp:TextBox runat="server" id="Zip" MaxLength="255" columns="10" cssclass="field_input" rows="0" textmode="SingleLine"></asp:TextBox>&nbsp;
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="CommentsTextBoxMaxLengthValidator" ControlToValidate="Comments" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IROC2&quot;).Replace(&quot;{FieldName}&quot;, &quot;Comments&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
