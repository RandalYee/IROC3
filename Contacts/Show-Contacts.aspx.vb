...
' This file implements the code-behind class for Show_Contacts.aspx.
' App_Code\Show_Contacts.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Contacts
        Inherits BaseApplicationPage
' Code-behind class for the Show_Contacts page.
