...
' This file implements the code-behind class for Edit_Contacts.aspx.
' App_Code\Edit_Contacts.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Edit_Contacts
        Inherits BaseApplicationPage
' Code-behind class for the Edit_Contacts page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Contacts"
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.ContactsRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.ContactsRecordControl.LoadData()
        Me.ContactsRecordControl.DataBind()
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
           ...
           Dim id As String = ""
            ...
            If target <> "" AndAlso field <> "" Then
                  ...
                  If Not Me.ContactsRecordControl Is Nothing AndAlso Not Me.ContactsRecordControl.DataSource Is Nothing Then
                        id = Me.ContactsRecordControl.DataSource.GetValue(Me.ContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString
                        If formula <> "" Then
                            Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                            variables.Add(Me.ContactsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.ContactsRecordControl.DataSource)
                            value = EvaluateFormula(formula, Me.ContactsRecordControl.DataSource, Nothing,variables)
                        ElseIf displayFieldName = "" Then
                            value = id
                        Else
                            value = Me.ContactsRecordControl.DataSource.GetValue(Me.ContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString
                        End If
                  End If
