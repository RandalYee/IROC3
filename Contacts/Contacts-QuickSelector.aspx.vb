...
' This file implements the code-behind class for Contacts_QuickSelector.aspx.
' App_Code\Contacts_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Contacts_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the Contacts_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_SelectorSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Contacts_QuickSelector.SelectorTableControl 
            control = new IROC2.UI.Controls.Contacts_QuickSelector.SelectorTableControl()
