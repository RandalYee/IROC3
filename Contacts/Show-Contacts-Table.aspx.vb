...
' This file implements the code-behind class for Show_Contacts_Table.aspx.
' App_Code\Show_Contacts_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Contacts_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_Contacts_Table page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_ContactsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Show_Contacts_Table.ContactsTableControl 
            control = new IROC2.UI.Controls.Show_Contacts_Table.ContactsTableControl()
