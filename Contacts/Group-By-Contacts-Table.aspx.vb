...
' This file implements the code-behind class for Group_By_Contacts_Table.aspx.
' App_Code\Group_By_Contacts_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Group_By_Contacts_Table
        Inherits BaseApplicationPage
' Code-behind class for the Group_By_Contacts_Table page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_ContactsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetContactsSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_ContactsSearch()
      ' or replace the call to GetAutoCompletionList_ContactsSearch().
      Return GetAutoCompletionList_ContactsSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.ContactsTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_ContactsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Group_By_Contacts_Table.ContactsTableControl 
            control = new IROC2.UI.Controls.Group_By_Contacts_Table.ContactsTableControl()
            
            Return control.GetAutoCompletionList_ContactsSearch(prefixText, count)
        ...
        Me.ContactsTableControl.LoadData()
        Me.ContactsTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "ContactsMenuItem"
                    End If
                End If
