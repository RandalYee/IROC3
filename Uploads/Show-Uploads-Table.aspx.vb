...
' This file implements the code-behind class for Show_Uploads_Table.aspx.
' App_Code\Show_Uploads_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Uploads_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_Uploads_Table page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_UploadsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Show_Uploads_Table.UploadsTableControl 
            control = new IROC2.UI.Controls.Show_Uploads_Table.UploadsTableControl()
