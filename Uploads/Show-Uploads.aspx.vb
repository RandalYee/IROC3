...
' This file implements the code-behind class for Show_Uploads.aspx.
' App_Code\Show_Uploads.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Uploads
        Inherits BaseApplicationPage
' Code-behind class for the Show_Uploads page.
