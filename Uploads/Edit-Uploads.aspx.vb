...
' This file implements the code-behind class for Edit_Uploads.aspx.
' App_Code\Edit_Uploads.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Edit_Uploads
        Inherits BaseApplicationPage
' Code-behind class for the Edit_Uploads page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Uploads"
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.UploadsRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.UploadsRecordControl.LoadData()
        Me.UploadsRecordControl.DataBind()
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
           ...
           Dim id As String = ""
            ...
            If target <> "" AndAlso field <> "" Then
                  ...
                  If Not Me.UploadsRecordControl Is Nothing AndAlso Not Me.UploadsRecordControl.DataSource Is Nothing Then
                        id = Me.UploadsRecordControl.DataSource.GetValue(Me.UploadsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString
                        If formula <> "" Then
                            Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                            variables.Add(Me.UploadsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.UploadsRecordControl.DataSource)
                            value = EvaluateFormula(formula, Me.UploadsRecordControl.DataSource, Nothing,variables)
                        ElseIf displayFieldName = "" Then
                            value = id
                        Else
                            value = Me.UploadsRecordControl.DataSource.GetValue(Me.UploadsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString
                        End If
                  End If
