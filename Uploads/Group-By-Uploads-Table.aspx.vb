...
' This file implements the code-behind class for Group_By_Uploads_Table.aspx.
' App_Code\Group_By_Uploads_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Group_By_Uploads_Table
        Inherits BaseApplicationPage
' Code-behind class for the Group_By_Uploads_Table page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_UploadsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetUploadsSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_UploadsSearch()
      ' or replace the call to GetAutoCompletionList_UploadsSearch().
      Return GetAutoCompletionList_UploadsSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.UploadsTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_UploadsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Group_By_Uploads_Table.UploadsTableControl 
            control = new IROC2.UI.Controls.Group_By_Uploads_Table.UploadsTableControl()
            
            Return control.GetAutoCompletionList_UploadsSearch(prefixText, count)
        ...
        Me.UploadsTableControl.LoadData()
        Me.UploadsTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "UploadsMenuItem"
                    End If
                End If
