...
' This file implements the code-behind class for Uploads_QuickSelector.aspx.
' App_Code\Uploads_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Uploads_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the Uploads_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_SelectorSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Uploads_QuickSelector.SelectorTableControl 
            control = new IROC2.UI.Controls.Uploads_QuickSelector.SelectorTableControl()
