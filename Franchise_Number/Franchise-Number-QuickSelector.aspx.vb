...
' This file implements the code-behind class for Franchise_Number_QuickSelector.aspx.
' App_Code\Franchise_Number_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Franchise_Number_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the Franchise_Number_QuickSelector page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_SelectorSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetSelectorSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_SelectorSearch()
      ' or replace the call to GetAutoCompletionList_SelectorSearch().
      Return GetAutoCompletionList_SelectorSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ScriptManager.RegisterStartupScript(Me, Me.GetType(), "PopupScript", "openPopupPage('QSSize');", True)
        End If
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.SelectorTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_SelectorSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Franchise_Number_QuickSelector.SelectorTableControl 
            control = new IROC2.UI.Controls.Franchise_Number_QuickSelector.SelectorTableControl()
            
            Return control.GetAutoCompletionList_SelectorSearch(prefixText, count)
        ...
        Me.SelectorTableControl.LoadData()
        Me.SelectorTableControl.DataBind()
