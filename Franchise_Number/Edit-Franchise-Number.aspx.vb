...
' This file implements the code-behind class for Edit_Franchise_Number.aspx.
' App_Code\Edit_Franchise_Number.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Edit_Franchise_Number
        Inherits BaseApplicationPage
' Code-behind class for the Edit_Franchise_Number page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Franchise Number"
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Franchise_NumberRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.Franchise_NumberRecordControl.LoadData()
        Me.Franchise_NumberRecordControl.DataBind()
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
           ...
           Dim id As String = ""
            ...
            If target <> "" AndAlso field <> "" Then
                  ...
                  If Not Me.Franchise_NumberRecordControl Is Nothing AndAlso Not Me.Franchise_NumberRecordControl.DataSource Is Nothing Then
                        id = Me.Franchise_NumberRecordControl.DataSource.GetValue(Me.Franchise_NumberRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString
                        If formula <> "" Then
                            Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                            variables.Add(Me.Franchise_NumberRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.Franchise_NumberRecordControl.DataSource)
                            value = EvaluateFormula(formula, Me.Franchise_NumberRecordControl.DataSource, Nothing,variables)
                        ElseIf displayFieldName = "" Then
                            value = id
                        Else
                            value = Me.Franchise_NumberRecordControl.DataSource.GetValue(Me.Franchise_NumberRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString
                        End If
                  End If
