...
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Show_Franchise_Number_Table" %>

<%@ Register Tagprefix="IROC2" TagName="PaginationMedium" Src="../Shared/PaginationMedium.ascx" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Franchise-Number-Table.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IROC2.UI.Show_Franchise_Number_Table" %>
