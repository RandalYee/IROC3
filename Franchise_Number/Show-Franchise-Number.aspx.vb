...
' This file implements the code-behind class for Show_Franchise_Number.aspx.
' App_Code\Show_Franchise_Number.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Franchise_Number
        Inherits BaseApplicationPage
' Code-behind class for the Show_Franchise_Number page.
