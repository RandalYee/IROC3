...
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Franchise_Number_QuickSelector" %>

<%@ Register Tagprefix="IROC2" TagName="PaginationClassic" Src="../Shared/PaginationClassic.ascx" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Franchise-Number-QuickSelector.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="IROC2.UI.Franchise_Number_QuickSelector" %>
