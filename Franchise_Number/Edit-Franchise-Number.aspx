...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Edit-Franchise-Number.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IROC2.UI.Edit_Franchise_Number" %>
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Edit_Franchise_Number" %>
