...
' This file implements the code-behind class for Show_Request_Master_Table.aspx.
' App_Code\Show_Request_Master_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Request_Master_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_Request_Master_Table page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Request_MasterSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Show_Request_Master_Table.Request_MasterTableControl 
            control = new IROC2.UI.Controls.Show_Request_Master_Table.Request_MasterTableControl()
