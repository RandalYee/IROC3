...
' This file implements the code-behind class for Add_Request_Master_Pop_up.aspx.
' App_Code\Add_Request_Master_Pop_up.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Add_Request_Master_Pop_up
        Inherits BaseApplicationPage
' Code-behind class for the Add_Request_Master_Pop_up page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Request Master"
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
           ...
           Dim id As String = ""
            ...
            If target <> "" AndAlso field <> "" Then
                  ...
                  If Not Me.Request_MasterRecordControl Is Nothing AndAlso Not Me.Request_MasterRecordControl.DataSource Is Nothing Then
                        id = Me.Request_MasterRecordControl.DataSource.GetValue(Me.Request_MasterRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString
                        If formula <> "" Then
                            Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                            variables.Add(Me.Request_MasterRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.Request_MasterRecordControl.DataSource)
                            value = EvaluateFormula(formula, Me.Request_MasterRecordControl.DataSource, Nothing,variables)
                        ElseIf displayFieldName = "" Then
                            value = id
                        Else
                            value = Me.Request_MasterRecordControl.DataSource.GetValue(Me.Request_MasterRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString
                        End If
                  End If
