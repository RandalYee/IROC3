...
' This file implements the code-behind class for Add_Request_Master.aspx.
' App_Code\Add_Request_Master.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Add_Request_Master
        Inherits BaseApplicationPage
' Code-behind class for the Add_Request_Master page.
    ...
    ' Page Event Handlers - buttons, sort, links
		...
		Public Sub SaveButton_Click(ByVal sender As Object, ByVal args As EventArgs)
          ' Click handler for SaveButton.
            ' Customize by adding code before the call or replace the call to the Base function with your own code. 
            'Me.Req_Enity2.Text = Me.EnityDownList.Text
            Me.Pending_Action_Dt.Text = System.DateTime.Now.ToShortDateString
            'Me.Reg_Type.Text = Me.RoleDownList.Text
            If Me.Reg_Type.Text.Trim = Me.Req_Enity2.Text.Trim Then  'Enity is Reqester.
                Me.Pending_Agency.Text = Me.Req_Enity2.Text.Trim
            Else
                Me.Pending_Agency.Text = "Requester"
            End If
            Me.Pending_Action_Needed.Text = "Enter Contact"
    ...
    Try
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../Request_Master/Edit-Request-Master.aspx?Request_Master={Request_MasterRecordControl:FV:Request_Id}&Agency=Requester"
