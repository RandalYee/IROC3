...
' This file implements the code-behind class for Show_Request_Master.aspx.
' App_Code\Show_Request_Master.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Request_Master
        Inherits BaseApplicationPage
' Code-behind class for the Show_Request_Master page.
