...
' This file implements the code-behind class for Request_Master_QuickSelector.aspx.
' App_Code\Request_Master_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Request_Master_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the Request_Master_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_SelectorSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Request_Master_QuickSelector.SelectorTableControl 
            control = new IROC2.UI.Controls.Request_Master_QuickSelector.SelectorTableControl()
