...
' This file implements the code-behind class for Save_Request_Master.aspx.
' App_Code\Save_Request_Master.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Save_Request_Master
        Inherits BaseApplicationPage
' Code-behind class for the Save_Request_Master page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
		...
		Public Sub Save_More_Info_Click(ByVal sender As Object, ByVal args As EventArgs)
          ' Click handler for Save_More_Info.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
			Me.Pending_Prev_Status.Text = Me.Req_Status.Text   '--Ryee
            Me.Req_Status.Text = "Need Info"
            Me.Pending_Prev_Action_Needed.Text = Me.Pending_Action_Needed1.Text
            Me.Pending_Action_Needed1.Text = "More Info Needed"
            Me.Pending_Agency_Return.Text = Me.Pending_Agency1.Text
            Me.Pending_Agency1.Text = Me.ToAgency.Text
            If Me.Pending_Agency1.Text.Trim = "Requester" Then
                If Me.Reg_Type1.Text.Trim = Me.Req_Enity2.Text.Trim Then  'Requester is Enity.
            ...
            Me.Cat_OTWC_Comments.Text = "catv@dcca.hawaii.gov, " & Get_Email("CATV")
            Save_More_Info_Click_Base(sender, args)
                ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        End Sub
            
'        Public Sub SendEmailOnSave_More_Info_Click()
'
'            ' Customize by adding code before the call or replace the call to the Base function with your own code.
'            SendEmailOnSave_More_Info_Click_Base()
'        End Sub
...
#Region "Section 2: Do not modify this section."
        ...
        Protected Sub Page_InitializeEventHandlers_Base(ByVal sender As Object, ByVal e As System.EventArgs)            		
          ...
          ' Setup the pagination events.
            ...
            AddHandler Me.Save_More_Info.Button.Click, AddressOf Save_More_Info_Click
        
            Me.Save_More_Info.Button.Attributes.Add("onclick", "SubmitHRefOnce(this, """ & Me.GetResourceValue("Txt:SaveRecord", "IROC2") & """);")
        ...
        Private Sub Base_RegisterPostback()
              ...
              Me.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"Save_More_Info"))
    ...
    End Function
      ...
      End Sub  
        ...
        Public Sub Save_More_Info_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
      ...
      url = Me.ModifyRedirectUrl(url, "",True)
              Me.CommitTransaction(sender)
                SendEmailOnSave_More_Info_Click()
    ...
    Public  Sub SendEmailOnSave_More_Info_Click_Base()
      ...
      SendEmail1Subject = Me.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("Request+For+More+Info++About+INET+%23%7bRequest_MasterRecordControl%3aNoUrlEncode%3aFDV%3aIROC_Id%7d"), "", False, Me)
