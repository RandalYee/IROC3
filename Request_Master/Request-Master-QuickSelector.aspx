...
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Request_Master_QuickSelector" %>

<%@ Register Tagprefix="IROC2" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Request-Master-QuickSelector.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="IROC2.UI.Request_Master_QuickSelector" %>
