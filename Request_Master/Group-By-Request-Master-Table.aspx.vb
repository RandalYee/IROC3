...
' This file implements the code-behind class for Group_By_Request_Master_Table.aspx.
' App_Code\Group_By_Request_Master_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Group_By_Request_Master_Table
        Inherits BaseApplicationPage
' Code-behind class for the Group_By_Request_Master_Table page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Request_MasterSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetRequest_MasterSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Request_MasterSearch()
      ' or replace the call to GetAutoCompletionList_Request_MasterSearch().
      Return GetAutoCompletionList_Request_MasterSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
			...
			Me.Authorize(Ctype(Request_MasterTableControl, Control), "NOT_ANONYMOUS")
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Request_MasterTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_Request_MasterSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Group_By_Request_Master_Table.Request_MasterTableControl 
            control = new IROC2.UI.Controls.Group_By_Request_Master_Table.Request_MasterTableControl()
            
            Return control.GetAutoCompletionList_Request_MasterSearch(prefixText, count)
        ...
        Me.Request_MasterTableControl.LoadData()
        Me.Request_MasterTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "Request_MasterMenuItem"
                    End If
                End If
