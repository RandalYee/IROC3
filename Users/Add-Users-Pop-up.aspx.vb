...
' This file implements the code-behind class for Add_Users_Pop_up.aspx.
' App_Code\Add_Users_Pop_up.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Add_Users_Pop_up
        Inherits BaseApplicationPage
' Code-behind class for the Add_Users_Pop_up page.
