...
' This file implements the code-behind class for Group_By_Users_Table.aspx.
' App_Code\Group_By_Users_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Group_By_Users_Table
        Inherits BaseApplicationPage
' Code-behind class for the Group_By_Users_Table page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_RoleSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Group_By_Users_Table.RoleTableControl 
            control = new IROC2.UI.Controls.Group_By_Users_Table.RoleTableControl()
        ...
        Public Shared Function GetAutoCompletionList_UsersSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            ' Hence we can not invoke any method associated with any controls.
            ' So, if we need to use any control in the page we need to instantiate it.
            Dim control as IROC2.UI.Controls.Group_By_Users_Table.UsersTableControl 
            control = new IROC2.UI.Controls.Group_By_Users_Table.UsersTableControl()
