...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Group-By-Users-Table.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IROC2.UI.Group_By_Users_Table" %>
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Group_By_Users_Table" %>
...
<tr><td class="ticnb" scope="row">
                        ...
                        </td><td class="ttc"><asp:Literal runat="server" id="User_Name"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="Email"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="IsActive"></asp:Literal> </td></tr><tr id="UsersTableControlAltRow" runat="server"><td class="ticnb" scope="row">&nbsp;</td><td class="ticnb" scope="row">&nbsp;</td><td class="ticnb" scope="row">&nbsp;</td><td class="ttc" colspan="3"><asp:TabContainer runat="server" id="UsersTabContainer">
 <asp:TabPanel runat="server" id="RoleTabPanel" HeaderText="Users Role">	<ContentTemplate>
  <IROC2:RoleTableControl runat="server" id="RoleTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td></td><td></td><td></td></tr><tr><td></td><td>
...
</asp:TabContainer></td></tr></IROC2:UsersTableControlRow>
</ITEMTEMPLATE>
