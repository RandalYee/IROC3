...
' This file implements the code-behind class for Show_Users_Table.aspx.
' App_Code\Show_Users_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Users_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_Users_Table page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_UsersSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Show_Users_Table.UsersTableControl 
            control = new IROC2.UI.Controls.Show_Users_Table.UsersTableControl()
