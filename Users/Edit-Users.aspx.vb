...
' This file implements the code-behind class for Edit_Users.aspx.
' App_Code\Edit_Users.Controls.vb contains the Table, Row and Record control classes
...
' Code-behind class for the Edit_Users page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_RoleSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetRoleSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_RoleSearch()
      ' or replace the call to GetAutoCompletionList_RoleSearch().
      Return GetAutoCompletionList_RoleSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.UsersRecordControl.SaveData()
        
            Me.RoleTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_RoleSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Edit_Users.RoleTableControl 
            control = new IROC2.UI.Controls.Edit_Users.RoleTableControl()
            
            Return control.GetAutoCompletionList_RoleSearch(prefixText, count)
        ...
        Me.UsersRecordControl.LoadData()
        Me.UsersRecordControl.DataBind()
        
          Me.RoleTableControl.LoadData()
          Me.RoleTableControl.DataBind()
           ...
           Dim id As String = ""
            ...
            If target <> "" AndAlso field <> "" Then
                  ...
                  If Not Me.UsersRecordControl Is Nothing AndAlso Not Me.UsersRecordControl.DataSource Is Nothing Then
                        id = Me.UsersRecordControl.DataSource.GetValue(Me.UsersRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString
                        If formula <> "" Then
                            Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                            variables.Add(Me.UsersRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.UsersRecordControl.DataSource)
                            value = EvaluateFormula(formula, Me.UsersRecordControl.DataSource, Nothing,variables)
                        ElseIf displayFieldName = "" Then
                            value = id
                        Else
                            value = Me.UsersRecordControl.DataSource.GetValue(Me.UsersRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString
                        End If
                  End If
