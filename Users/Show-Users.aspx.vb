...
' This file implements the code-behind class for Show_Users.aspx.
' App_Code\Show_Users.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Users
        Inherits BaseApplicationPage
' Code-behind class for the Show_Users page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_RoleSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Show_Users.RoleTableControl 
            control = new IROC2.UI.Controls.Show_Users.RoleTableControl()
