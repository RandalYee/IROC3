...
' This file implements the code-behind class for Add_Users.aspx.
' App_Code\Add_Users.Controls.vb contains the Table, Row and Record control classes
...
' Code-behind class for the Add_Users page.
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SaveAndNewButton_Click(ByVal sender As Object, ByVal args As EventArgs)
          ' Click handler for SaveAndNewButton.
            ' Customize by adding code before the call or replace the call to the Base function with your own code.
            '--Ryee 
            Me.Agency.Text = EvaluateFormula("GetColumnValue(""Enity"", " & CInt(Me.AgencyDropDownList.Text) & ", ""Enity_Codes"")")
            Me.Enity.Text = EvaluateFormula("GetColumnValue(""Enity"", " & CInt(Me.AgencyDropDownList.Text) & ", ""Enity_Type"")")
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Users"
