...
' This file implements the code-behind class for Show_Enity_Table.aspx.
' App_Code\Show_Enity_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Enity_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_Enity_Table page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_EnitySearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Show_Enity_Table.EnityTableControl 
            control = new IROC2.UI.Controls.Show_Enity_Table.EnityTableControl()
