...
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Edit_Enity" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Edit-Enity.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IROC2.UI.Edit_Enity" %>
...
</td></tr><tr><td class="fls"><asp:Literal runat="server" id="Enity_CodesLabel" Text="Agency: (max 20 char)">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="Enity_CodesTextBoxMaxLengthValidator" ControlToValidate="Enity_Codes" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IROC2&quot;).Replace(&quot;{FieldName}&quot;, &quot;Enity Codes&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td></tr><tr><td class="fls"><asp:Literal runat="server" id="Enity_TypeLabel" Text="Type: (max 10 char)">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="fls"><asp:Literal runat="server" id="DeptAgencyNamesLabel" Text="Department Agency Names">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
