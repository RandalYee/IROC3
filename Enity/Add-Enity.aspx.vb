...
' This file implements the code-behind class for Add_Enity.aspx.
' App_Code\Add_Enity.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Add_Enity
        Inherits BaseApplicationPage
' Code-behind class for the Add_Enity page.
