...
' This file implements the code-behind class for Group_By_Enity_Table.aspx.
' App_Code\Group_By_Enity_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Group_By_Enity_Table
        Inherits BaseApplicationPage
' Code-behind class for the Group_By_Enity_Table page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_EnitySearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetEnitySearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_EnitySearch()
      ' or replace the call to GetAutoCompletionList_EnitySearch().
      Return GetAutoCompletionList_EnitySearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_EnitySearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Group_By_Enity_Table.EnityTableControl 
            control = new IROC2.UI.Controls.Group_By_Enity_Table.EnityTableControl()
            
            Return control.GetAutoCompletionList_EnitySearch(prefixText, count)
        ...
        Me.EnityTableControl.LoadData()
        Me.EnityTableControl.DataBind()
