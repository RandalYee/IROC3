...
' This file implements the code-behind class for Add_Enity_Pop_up.aspx.
' App_Code\Add_Enity_Pop_up.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Add_Enity_Pop_up
        Inherits BaseApplicationPage
' Code-behind class for the Add_Enity_Pop_up page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Enity"
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.EnityRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.EnityRecordControl.LoadData()
        Me.EnityRecordControl.DataBind()
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
           ...
           Dim id As String = ""
            ...
            If target <> "" AndAlso field <> "" Then
                  ...
                  If Not Me.EnityRecordControl Is Nothing AndAlso Not Me.EnityRecordControl.DataSource Is Nothing Then
                        id = Me.EnityRecordControl.DataSource.GetValue(Me.EnityRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString
                        If formula <> "" Then
                            Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                            variables.Add(Me.EnityRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.EnityRecordControl.DataSource)
                            value = EvaluateFormula(formula, Me.EnityRecordControl.DataSource, Nothing,variables)
                        ElseIf displayFieldName = "" Then
                            value = id
                        Else
                            value = Me.EnityRecordControl.DataSource.GetValue(Me.EnityRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString
                        End If
                  End If
