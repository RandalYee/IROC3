...
' This file implements the code-behind class for Enity_QuickSelector.aspx.
' App_Code\Enity_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Enity_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the Enity_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_SelectorSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Enity_QuickSelector.SelectorTableControl 
            control = new IROC2.UI.Controls.Enity_QuickSelector.SelectorTableControl()
