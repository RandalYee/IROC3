...
' This file implements the code-behind class for Show_Enity.aspx.
' App_Code\Show_Enity.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Enity
        Inherits BaseApplicationPage
' Code-behind class for the Show_Enity page.
