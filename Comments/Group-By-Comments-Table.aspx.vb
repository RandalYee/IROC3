...
' This file implements the code-behind class for Group_By_Comments_Table.aspx.
' App_Code\Group_By_Comments_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Group_By_Comments_Table
        Inherits BaseApplicationPage
' Code-behind class for the Group_By_Comments_Table page.
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.CommentsTableControl.SaveData()
      ...
      End Sub  
        ...
        Me.CommentsTableControl.LoadData()
        Me.CommentsTableControl.DataBind()
