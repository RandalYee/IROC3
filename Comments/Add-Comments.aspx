...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Add-Comments.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IROC2.UI.Add_Comments" %>
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Add_Comments" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <asp:panel id="CommentsRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="CommentsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="fls"><asp:Literal runat="server" id="Request_IdLabel" Text="Request">	</asp:Literal></td><td class="dfv"><BaseClasses:QuickSelector runat="server" id="Request_Id" redirecturl=""></BaseClasses:QuickSelector> </td><td class="fls"><asp:Literal runat="server" id="Comment_DtLabel" Text="Comment DT">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="Comment_Dt" Columns="20" MaxLength="30" cssclass="field_input"></asp:TextBox></td>
<td>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="Comment_DtTextBoxMaxLengthValidator" ControlToValidate="Comment_Dt" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IROC2&quot;).Replace(&quot;{FieldName}&quot;, &quot;Comment DT&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td></tr><tr><td class="fls"><asp:Literal runat="server" id="AgencyLabel" Text="Agency">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
<asp:TextBox runat="server" id="Agency" Columns="10" MaxLength="10" cssclass="field_input"></asp:TextBox>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="AgencyTextBoxMaxLengthValidator" ControlToValidate="Agency" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IROC2&quot;).Replace(&quot;{FieldName}&quot;, &quot;Agency&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td><td class="fls"><asp:Literal runat="server" id="Comment_TopicLabel" Text="Comment Topic">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="Comment_TopicTextBoxMaxLengthValidator" ControlToValidate="Comment_Topic" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IROC2&quot;).Replace(&quot;{FieldName}&quot;, &quot;Comment Topic&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td></tr><tr><td class="fls"><asp:Literal runat="server" id="Comment_To_AgencyLabel" Text="Comment To Agency">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="Comment_To_AgencyTextBoxMaxLengthValidator" ControlToValidate="Comment_To_Agency" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IROC2&quot;).Replace(&quot;{FieldName}&quot;, &quot;Comment To Agency&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td><td class="dfv"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="CommentLabel" Text="Comment">	</asp:Literal></td><td class="dfv" colspan="3"><asp:TextBox runat="server" id="Comment" MaxLength="255" columns="120" cssclass="field_input" rows="5" textmode="MultiLine"></asp:TextBox>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="CommentTextBoxMaxLengthValidator" ControlToValidate="Comment" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IROC2&quot;).Replace(&quot;{FieldName}&quot;, &quot;Comment&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator> </td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
