...
' This file implements the code-behind class for Show_Comments_Table.aspx.
' App_Code\Show_Comments_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Comments_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_Comments_Table page.
