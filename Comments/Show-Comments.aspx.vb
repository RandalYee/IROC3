...
' This file implements the code-behind class for Show_Comments.aspx.
' App_Code\Show_Comments.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Comments
        Inherits BaseApplicationPage
' Code-behind class for the Show_Comments page.
