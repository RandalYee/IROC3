...
' This file implements the code-behind class for Comments_QuickSelector.aspx.
' App_Code\Comments_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Comments_QuickSelector
        Inherits BaseApplicationPage
' Code-behind class for the Comments_QuickSelector page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_SelectorSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as IROC2.UI.Controls.Comments_QuickSelector.SelectorTableControl 
            control = new IROC2.UI.Controls.Comments_QuickSelector.SelectorTableControl()
