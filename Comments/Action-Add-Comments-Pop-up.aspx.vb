...
' This file implements the code-behind class for Action_Add_Comments_Pop_up.aspx.
' App_Code\Auto_Add_Comments_Pop_up.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Action_Add_Comments_Pop_up
        Inherits BaseApplicationPage
' Code-behind class for the Action_Add_Comments_Pop_up page.
