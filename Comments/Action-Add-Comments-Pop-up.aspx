...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Action-Add-Comments-Pop-up.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="IROC2.UI.Action_Add_Comments_Pop_up" %>
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Action_Add_Comments_Pop_up" %>
...
</td><td class="dfv"><asp:Literal runat="server" id="Request_IdLabel" Text="Request" visible="False">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="Request_Id" visible="False"></asp:Literal></td></tr><tr><td class="fls"><asp:Literal runat="server" id="Comment_TopicLabel" Text="Topic">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
...
</td><td class="dfv"><asp:Literal runat="server" id="Role_IDMaxControl" visible="False">	</asp:Literal></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="Created_ByLabel" Text="Created By:">	</asp:Literal></td><td class="dfv"><span style="white-space:nowrap;">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="CommentTextBoxMaxLengthValidator" ControlToValidate="Comment" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;IROC2&quot;).Replace(&quot;{FieldName}&quot;, &quot;Comment&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator> </td><td class="dfv"></td><td class="dfv"></td></tr></table></asp:panel>
</div></td></tr></table>
</asp:panel>
