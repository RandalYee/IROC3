...
' This file implements the code-behind class for MoreInfo_Add_Comments_Pop_up.aspx.
' App_Code\MoreInfo_Add_Comments_Pop_up.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class MoreInfo_Add_Comments_Pop_up
        Inherits BaseApplicationPage
' Code-behind class for the MoreInfo_Add_Comments_Pop_up page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
		...
		Public Sub SaveButton_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Me.TypeList.Text = "--PLEASE_SELECT--" Then
                Utils.MiscUtils.RegisterJScriptAlert(Me, "BUTTON_CLICK_MESSAGE", "No To_Agency Selected!")
                Exit Sub
            ElseIf Me.TypeList.Text = "Entity" Then
                Me.Comment_To_Agency.Text = Me.Entity.Text
            ElseIf Me.TypeList.Text = "Provider" Then
                Me.Comment_To_Agency.Text = Me.Provider.Text
            Else
                Me.Comment_To_Agency.Text = Me.TypeList.Text

            End If
            If Me.Agency.Text = Me.Comment_To_Agency.Text Then
                Utils.MiscUtils.RegisterJScriptAlert(Me, "BUTTON_CLICK_MESSAGE", "Requesting More Info Needed From Yourself Not Allowed!  Select Another To_Agency.")
                Exit Sub
            End If
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
			...
			Me.Authorize(Ctype(CommentsRecordControl, Control), "NOT_ANONYMOUS")
    ...
    Try
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../Request_Master/Save-Request-Master.aspx?Request_Master={CommentsRecordControl:FV:Request_Id}&To_Agency={CommentsRecordControl:FV:Comment_To_Agency}"
