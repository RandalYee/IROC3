...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Comments-QuickSelector.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="IROC2.UI.Comments_QuickSelector" %>
<%@ Register Tagprefix="IROC2" TagName="PaginationClassic" Src="../Shared/PaginationClassic.ascx" %>

<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Comments_QuickSelector" %>
