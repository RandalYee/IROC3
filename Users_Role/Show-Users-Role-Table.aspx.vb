...
' This file implements the code-behind class for Show_Users_Role_Table.aspx.
' App_Code\Show_Users_Role_Table.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Users_Role_Table
        Inherits BaseApplicationPage
' Code-behind class for the Show_Users_Role_Table page.
