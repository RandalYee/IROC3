<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Users-Role-Table.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="IROC2.UI.Show_Users_Role_Table" %>
...
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Show_Users_Role_Table" %>
    ...
    <asp:UpdateProgress runat="server" id="UpdatePanel1_UpdateProgress1" AssociatedUpdatePanelID="UpdatePanel1">
		...
		<asp:UpdatePanel runat="server" id="UpdatePanel1" UpdateMode="Conditional">
            ...
            <!--To change the position of the pagination control, please search for "prspace" on the Online Help for instruction. --></td><td><img src="../Images/paginationRowEdgeR.gif" alt="" /></td><td></td></tr></table>
                           ...
                           <asp:Literal runat="server" id="UsersRecordControlLabel" Text="Users">	</asp:Literal>    
                        </th><th class="thc" scope="col">
                           <asp:Literal runat="server" id="RoleRecordControlLabel" Text="Role">	</asp:Literal>    
...
<tr><td class="ticnb" scope="row">
                        ...
                        </td><td class="ttc"><asp:Literal runat="server" id="User_Literal" Text="MyLiteral">	</asp:Literal></td><td class="ttc"><asp:Literal runat="server" id="Literal" Text="MyLiteral">	</asp:Literal></td></tr></IROC2:Users_RoleTableControlRow>
</ITEMTEMPLATE>
