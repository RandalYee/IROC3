...
' This file implements the code-behind class for Show_Users_Role.aspx.
' App_Code\Show_Users_Role.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Show_Users_Role
        Inherits BaseApplicationPage
' Code-behind class for the Show_Users_Role page.
