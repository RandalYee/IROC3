...
<%@ Register Tagprefix="IROC2" Namespace="IROC2.UI.Controls.Add_Users_Role_Pop_up" %>

<%@ Register Tagprefix="IROC2" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Add-Users-Role-Pop-up.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="IROC2.UI.Add_Users_Role_Pop_up" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <asp:panel id="Users_RoleRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><div class="scrollRegion"><asp:panel id="Users_RoleRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="User_IDLabel" Text="User">	</asp:Literal></td><td class="dfv"><BaseClasses:QuickSelector runat="server" id="User_ID" redirecturl=""></BaseClasses:QuickSelector> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="Role_IDLabel" Text="Role">	</asp:Literal></td><td class="dfv"><BaseClasses:QuickSelector runat="server" id="Role_ID" redirecturl=""></BaseClasses:QuickSelector> </td></tr></table></asp:panel>
</div></td></tr></table>
</asp:panel>
