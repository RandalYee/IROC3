...
' This file implements the code-behind class for Add_Users_Role.aspx.
' App_Code\Add_Users_Role.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Add_Users_Role
        Inherits BaseApplicationPage
' Code-behind class for the Add_Users_Role page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
		...
		Public Sub SaveAndNewButton_Click(ByVal sender As Object, ByVal args As EventArgs)
          ...
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
            '--Ryee
            Me.Role_ID.Text = Role_DropDownList.Text
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Users Role"
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Users_RoleRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.Users_RoleRecordControl.LoadData()
        Me.Users_RoleRecordControl.DataBind()
