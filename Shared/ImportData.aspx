...
<%@ Page Language="VB" EnableEventValidation="false" AutoEventWireup="false" Codefile="ImportData.aspx.vb" Inherits="IROC2.UI.ImportData" %>
				...
				<table class="importWizarddv" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td class="importWizarddBody" style="width:100%; height:100%">			
							...
							<table>
								<tr>
									<td><IROC2:ThemeButton runat="server" id="PreviousButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Previous&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Previous&quot;, &quot;IROC2&quot;) %>">
		</IROC2:ThemeButton></td>
									<td><IROC2:ThemeButton runat="server" id="ImportButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Import&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Import&quot;, &quot;IROC2&quot;) %>">
		</IROC2:ThemeButton></td>
								</tr>
							</table>
						</td>
