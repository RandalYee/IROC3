        ...
        <tr>
			...
			<td class="configureErrorPagesText"><br />
				...
				<ol>
			      ...
			      <li>Go to the Application Explorer, navigate to the page that contains the New button or icon.<br /><br />
			      <ul style="list-style-type:disc">
			      	<li>Select the New button or icon on the page. Then click the Button actions in the Properties panel.</li>
			      	<li>In the Properties wizard, modify the Redirect URL to point to your Add Record page.<br />Example:  ../MyPages/MyAddRecordPage.aspx<br /><br /></li>
			      </ul>
			      </li>
